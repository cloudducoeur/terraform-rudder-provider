...
// checks if the DeleteAccount200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteAccount200Response{}

// DeleteAccount200Response struct for DeleteAccount200Response
...
type _DeleteAccount200Response DeleteAccount200Response
...
func (o DeleteAccount200Response) MarshalJSON() ([]byte, error) {
...
func (o DeleteAccount200Response) ToMap() (map[string]interface{}, error) {
...
func (o *DeleteAccount200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteAccount200Response := _DeleteAccount200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteAccount200Response)

	if err != nil {
		return err
	}

	*o = DeleteAccount200Response(varDeleteAccount200Response)

	return err
}

type NullableDeleteAccount200Response struct {
	value *DeleteAccount200Response
	isSet bool
}

func (v NullableDeleteAccount200Response) Get() *DeleteAccount200Response {
	return v.value
}

func (v *NullableDeleteAccount200Response) Set(val *DeleteAccount200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteAccount200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteAccount200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteAccount200Response(val *DeleteAccount200Response) *NullableDeleteAccount200Response {
	return &NullableDeleteAccount200Response{value: val, isSet: true}
}

func (v NullableDeleteAccount200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteAccount200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
