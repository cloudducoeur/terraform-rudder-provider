...
// checks if the RoleCoverageRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoleCoverageRequest{}

// RoleCoverageRequest struct for RoleCoverageRequest
...
type _RoleCoverageRequest RoleCoverageRequest
...
func (o RoleCoverageRequest) MarshalJSON() ([]byte, error) {
...
func (o RoleCoverageRequest) ToMap() (map[string]interface{}, error) {
...
func (o *RoleCoverageRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varRoleCoverageRequest := _RoleCoverageRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRoleCoverageRequest)

	if err != nil {
		return err
	}

	*o = RoleCoverageRequest(varRoleCoverageRequest)

	return err
}

type NullableRoleCoverageRequest struct {
	value *RoleCoverageRequest
	isSet bool
}

func (v NullableRoleCoverageRequest) Get() *RoleCoverageRequest {
	return v.value
}

func (v *NullableRoleCoverageRequest) Set(val *RoleCoverageRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableRoleCoverageRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableRoleCoverageRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoleCoverageRequest(val *RoleCoverageRequest) *NullableRoleCoverageRequest {
	return &NullableRoleCoverageRequest{value: val, isSet: true}
}

func (v NullableRoleCoverageRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoleCoverageRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
