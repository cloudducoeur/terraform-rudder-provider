...
type CampaignDetailsInfoSchedule struct {
	CampaignScheduleDaily *CampaignScheduleDaily
...
// CampaignScheduleDailyAsCampaignDetailsInfoSchedule is a convenience function that returns CampaignScheduleDaily wrapped in CampaignDetailsInfoSchedule
func CampaignScheduleDailyAsCampaignDetailsInfoSchedule(v *CampaignScheduleDaily) CampaignDetailsInfoSchedule {
	return CampaignDetailsInfoSchedule{
		CampaignScheduleDaily: v,
	}
}
...
func (dst *CampaignDetailsInfoSchedule) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	// try to unmarshal data into CampaignScheduleDaily
	err = newStrictDecoder(data).Decode(&dst.CampaignScheduleDaily)
	if err == nil {
		jsonCampaignScheduleDaily, _ := json.Marshal(dst.CampaignScheduleDaily)
		if string(jsonCampaignScheduleDaily) == "{}" { // empty struct
			dst.CampaignScheduleDaily = nil
		} else {
			if err = validator.Validate(dst.CampaignScheduleDaily); err != nil {
				dst.CampaignScheduleDaily = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonCampaignScheduleMonthly) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.CampaignScheduleMonthly); err != nil {
				dst.CampaignScheduleMonthly = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonCampaignScheduleOneshot) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.CampaignScheduleOneshot); err != nil {
				dst.CampaignScheduleOneshot = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonCampaignScheduleWeekly) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.CampaignScheduleWeekly); err != nil {
				dst.CampaignScheduleWeekly = nil
			} else {
				match++
			}
...
func (src CampaignDetailsInfoSchedule) MarshalJSON() ([]byte, error) {
	if src.CampaignScheduleDaily != nil {
		return json.Marshal(&src.CampaignScheduleDaily)
	}
...
func (obj *CampaignDetailsInfoSchedule) GetActualInstance() (interface{}) {
	...
	if obj.CampaignScheduleDaily != nil {
		return obj.CampaignScheduleDaily
	}
...
func (obj CampaignDetailsInfoSchedule) GetActualInstanceValue() (interface{}) {
	if obj.CampaignScheduleDaily != nil {
		return *obj.CampaignScheduleDaily
	}
