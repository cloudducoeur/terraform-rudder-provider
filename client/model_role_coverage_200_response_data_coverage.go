...
// checks if the RoleCoverage200ResponseDataCoverage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoleCoverage200ResponseDataCoverage{}

// RoleCoverage200ResponseDataCoverage struct for RoleCoverage200ResponseDataCoverage
type RoleCoverage200ResponseDataCoverage struct {
	// List of roles
	Permissions []string `json:"permissions"`
	// List of custom rights
	Custom []string `json:"custom"`
}

type _RoleCoverage200ResponseDataCoverage RoleCoverage200ResponseDataCoverage
...
func NewRoleCoverage200ResponseDataCoverage(permissions []string, custom []string) *RoleCoverage200ResponseDataCoverage {
	this := RoleCoverage200ResponseDataCoverage{}
...
func (o RoleCoverage200ResponseDataCoverage) MarshalJSON() ([]byte, error) {
...
func (o RoleCoverage200ResponseDataCoverage) ToMap() (map[string]interface{}, error) {
...
func (o *RoleCoverage200ResponseDataCoverage) UnmarshalJSON(data []byte) (err error) {
	...
	varRoleCoverage200ResponseDataCoverage := _RoleCoverage200ResponseDataCoverage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRoleCoverage200ResponseDataCoverage)

	if err != nil {
		return err
	}

	*o = RoleCoverage200ResponseDataCoverage(varRoleCoverage200ResponseDataCoverage)

	return err
}

type NullableRoleCoverage200ResponseDataCoverage struct {
	value *RoleCoverage200ResponseDataCoverage
	isSet bool
}

func (v NullableRoleCoverage200ResponseDataCoverage) Get() *RoleCoverage200ResponseDataCoverage {
	return v.value
}

func (v *NullableRoleCoverage200ResponseDataCoverage) Set(val *RoleCoverage200ResponseDataCoverage) {
	v.value = val
	v.isSet = true
}

func (v NullableRoleCoverage200ResponseDataCoverage) IsSet() bool {
	return v.isSet
}

func (v *NullableRoleCoverage200ResponseDataCoverage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoleCoverage200ResponseDataCoverage(val *RoleCoverage200ResponseDataCoverage) *NullableRoleCoverage200ResponseDataCoverage {
	return &NullableRoleCoverage200ResponseDataCoverage{value: val, isSet: true}
}

func (v NullableRoleCoverage200ResponseDataCoverage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoleCoverage200ResponseDataCoverage) UnmarshalJSON(src []byte) error {
	v.isSet = true
