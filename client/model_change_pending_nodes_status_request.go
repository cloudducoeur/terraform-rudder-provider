...
// checks if the ChangePendingNodesStatusRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangePendingNodesStatusRequest{}

// ChangePendingNodesStatusRequest struct for ChangePendingNodesStatusRequest
type ChangePendingNodesStatusRequest struct {
...
func NewChangePendingNodesStatusRequest() *ChangePendingNodesStatusRequest {
	this := ChangePendingNodesStatusRequest{}
	return &this
}
...
func (o ChangePendingNodesStatusRequest) MarshalJSON() ([]byte, error) {
...
func (o ChangePendingNodesStatusRequest) ToMap() (map[string]interface{}, error) {
...
type NullableChangePendingNodesStatusRequest struct {
	value *ChangePendingNodesStatusRequest
	isSet bool
}

func (v NullableChangePendingNodesStatusRequest) Get() *ChangePendingNodesStatusRequest {
	return v.value
}

func (v *NullableChangePendingNodesStatusRequest) Set(val *ChangePendingNodesStatusRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableChangePendingNodesStatusRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableChangePendingNodesStatusRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangePendingNodesStatusRequest(val *ChangePendingNodesStatusRequest) *NullableChangePendingNodesStatusRequest {
	return &NullableChangePendingNodesStatusRequest{value: val, isSet: true}
}

func (v NullableChangePendingNodesStatusRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangePendingNodesStatusRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
