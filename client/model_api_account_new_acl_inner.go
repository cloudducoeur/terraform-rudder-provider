...
// checks if the ApiAccountNewAclInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiAccountNewAclInner{}

// ApiAccountNewAclInner struct for ApiAccountNewAclInner
type ApiAccountNewAclInner struct {
	// API path managed by that access control
	Path *string `json:"path,omitempty"`
	// List of HTTP verb allowed
...
func (o ApiAccountNewAclInner) MarshalJSON() ([]byte, error) {
...
func (o ApiAccountNewAclInner) ToMap() (map[string]interface{}, error) {
...
type NullableApiAccountNewAclInner struct {
	value *ApiAccountNewAclInner
	isSet bool
}

func (v NullableApiAccountNewAclInner) Get() *ApiAccountNewAclInner {
	return v.value
}

func (v *NullableApiAccountNewAclInner) Set(val *ApiAccountNewAclInner) {
	v.value = val
	v.isSet = true
}

func (v NullableApiAccountNewAclInner) IsSet() bool {
	return v.isSet
}

func (v *NullableApiAccountNewAclInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiAccountNewAclInner(val *ApiAccountNewAclInner) *NullableApiAccountNewAclInner {
	return &NullableApiAccountNewAclInner{value: val, isSet: true}
}

func (v NullableApiAccountNewAclInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiAccountNewAclInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
