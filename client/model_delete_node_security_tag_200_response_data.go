...
// checks if the DeleteNodeSecurityTag200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteNodeSecurityTag200ResponseData{}

// DeleteNodeSecurityTag200ResponseData struct for DeleteNodeSecurityTag200ResponseData
type DeleteNodeSecurityTag200ResponseData struct {
	Nodes []string `json:"nodes"`
}

type _DeleteNodeSecurityTag200ResponseData DeleteNodeSecurityTag200ResponseData
...
func NewDeleteNodeSecurityTag200ResponseData(nodes []string) *DeleteNodeSecurityTag200ResponseData {
	this := DeleteNodeSecurityTag200ResponseData{}
	this.Nodes = nodes
	return &this
}
...
func (o DeleteNodeSecurityTag200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o DeleteNodeSecurityTag200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["nodes"] = o.Nodes
	return toSerialize, nil
}

func (o *DeleteNodeSecurityTag200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteNodeSecurityTag200ResponseData := _DeleteNodeSecurityTag200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteNodeSecurityTag200ResponseData)

	if err != nil {
		return err
	}

	*o = DeleteNodeSecurityTag200ResponseData(varDeleteNodeSecurityTag200ResponseData)

	return err
}

type NullableDeleteNodeSecurityTag200ResponseData struct {
	value *DeleteNodeSecurityTag200ResponseData
	isSet bool
}

func (v NullableDeleteNodeSecurityTag200ResponseData) Get() *DeleteNodeSecurityTag200ResponseData {
	return v.value
}

func (v *NullableDeleteNodeSecurityTag200ResponseData) Set(val *DeleteNodeSecurityTag200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteNodeSecurityTag200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteNodeSecurityTag200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteNodeSecurityTag200ResponseData(val *DeleteNodeSecurityTag200ResponseData) *NullableDeleteNodeSecurityTag200ResponseData {
	return &NullableDeleteNodeSecurityTag200ResponseData{value: val, isSet: true}
}

func (v NullableDeleteNodeSecurityTag200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteNodeSecurityTag200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
