...
// checks if the ModifySetting200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModifySetting200ResponseData{}

// ModifySetting200ResponseData Information about the setting
type ModifySetting200ResponseData struct {
...
func NewModifySetting200ResponseData() *ModifySetting200ResponseData {
	this := ModifySetting200ResponseData{}
	return &this
}
...
func (o ModifySetting200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o ModifySetting200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableModifySetting200ResponseData struct {
	value *ModifySetting200ResponseData
	isSet bool
}

func (v NullableModifySetting200ResponseData) Get() *ModifySetting200ResponseData {
	return v.value
}

func (v *NullableModifySetting200ResponseData) Set(val *ModifySetting200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableModifySetting200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableModifySetting200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModifySetting200ResponseData(val *ModifySetting200ResponseData) *NullableModifySetting200ResponseData {
	return &NullableModifySetting200ResponseData{value: val, isSet: true}
}

func (v NullableModifySetting200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModifySetting200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
