...
// checks if the SetNodeSecurityTagsRequestInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SetNodeSecurityTagsRequestInner{}

// SetNodeSecurityTagsRequestInner struct for SetNodeSecurityTagsRequestInner
type SetNodeSecurityTagsRequestInner struct {
	// the ID of the tenant to set on nodes
	TenantId string `json:"tenantId"`
	NodeIds []string `json:"nodeIds"`
}

type _SetNodeSecurityTagsRequestInner SetNodeSecurityTagsRequestInner
...
func NewSetNodeSecurityTagsRequestInner(tenantId string, nodeIds []string) *SetNodeSecurityTagsRequestInner {
	this := SetNodeSecurityTagsRequestInner{}
...
func (o SetNodeSecurityTagsRequestInner) MarshalJSON() ([]byte, error) {
...
func (o SetNodeSecurityTagsRequestInner) ToMap() (map[string]interface{}, error) {
...
func (o *SetNodeSecurityTagsRequestInner) UnmarshalJSON(data []byte) (err error) {
	...
	varSetNodeSecurityTagsRequestInner := _SetNodeSecurityTagsRequestInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSetNodeSecurityTagsRequestInner)

	if err != nil {
		return err
	}

	*o = SetNodeSecurityTagsRequestInner(varSetNodeSecurityTagsRequestInner)

	return err
}

type NullableSetNodeSecurityTagsRequestInner struct {
	value *SetNodeSecurityTagsRequestInner
	isSet bool
}

func (v NullableSetNodeSecurityTagsRequestInner) Get() *SetNodeSecurityTagsRequestInner {
	return v.value
}

func (v *NullableSetNodeSecurityTagsRequestInner) Set(val *SetNodeSecurityTagsRequestInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSetNodeSecurityTagsRequestInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSetNodeSecurityTagsRequestInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSetNodeSecurityTagsRequestInner(val *SetNodeSecurityTagsRequestInner) *NullableSetNodeSecurityTagsRequestInner {
	return &NullableSetNodeSecurityTagsRequestInner{value: val, isSet: true}
}

func (v NullableSetNodeSecurityTagsRequestInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSetNodeSecurityTagsRequestInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
