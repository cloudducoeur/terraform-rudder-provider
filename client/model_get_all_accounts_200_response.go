...
// checks if the GetAllAccounts200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAllAccounts200Response{}

// GetAllAccounts200Response struct for GetAllAccounts200Response
type GetAllAccounts200Response struct {
...
type _GetAllAccounts200Response GetAllAccounts200Response
...
func NewGetAllAccounts200Response(result string, action string, data GetAllAccounts200ResponseData) *GetAllAccounts200Response {
	this := GetAllAccounts200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o GetAllAccounts200Response) MarshalJSON() ([]byte, error) {
...
func (o GetAllAccounts200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetAllAccounts200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetAllAccounts200Response := _GetAllAccounts200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetAllAccounts200Response)

	if err != nil {
		return err
	}

	*o = GetAllAccounts200Response(varGetAllAccounts200Response)

	return err
}

type NullableGetAllAccounts200Response struct {
	value *GetAllAccounts200Response
	isSet bool
}

func (v NullableGetAllAccounts200Response) Get() *GetAllAccounts200Response {
	return v.value
}

func (v *NullableGetAllAccounts200Response) Set(val *GetAllAccounts200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAllAccounts200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAllAccounts200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAllAccounts200Response(val *GetAllAccounts200Response) *NullableGetAllAccounts200Response {
	return &NullableGetAllAccounts200Response{value: val, isSet: true}
}

func (v NullableGetAllAccounts200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAllAccounts200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
