...
// checks if the GetPluginsInfo200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPluginsInfo200Response{}

// GetPluginsInfo200Response struct for GetPluginsInfo200Response
type GetPluginsInfo200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data GetPluginsInfo200ResponseData `json:"data"`
}

type _GetPluginsInfo200Response GetPluginsInfo200Response
...
func NewGetPluginsInfo200Response(result string, action string, data GetPluginsInfo200ResponseData) *GetPluginsInfo200Response {
	this := GetPluginsInfo200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *GetPluginsInfo200Response) GetData() GetPluginsInfo200ResponseData {
	if o == nil {
		var ret GetPluginsInfo200ResponseData
		return ret
	}
...
func (o GetPluginsInfo200Response) MarshalJSON() ([]byte, error) {
...
func (o GetPluginsInfo200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetPluginsInfo200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetPluginsInfo200Response := _GetPluginsInfo200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetPluginsInfo200Response)

	if err != nil {
		return err
	}

	*o = GetPluginsInfo200Response(varGetPluginsInfo200Response)

	return err
}

type NullableGetPluginsInfo200Response struct {
	value *GetPluginsInfo200Response
	isSet bool
}

func (v NullableGetPluginsInfo200Response) Get() *GetPluginsInfo200Response {
	return v.value
}

func (v *NullableGetPluginsInfo200Response) Set(val *GetPluginsInfo200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPluginsInfo200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPluginsInfo200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPluginsInfo200Response(val *GetPluginsInfo200Response) *NullableGetPluginsInfo200Response {
	return &NullableGetPluginsInfo200Response{value: val, isSet: true}
}

func (v NullableGetPluginsInfo200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPluginsInfo200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
