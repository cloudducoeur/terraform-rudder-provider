...
// checks if the GetTenants200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTenants200Response{}
...
type _GetTenants200Response GetTenants200Response
...
func (o GetTenants200Response) MarshalJSON() ([]byte, error) {
...
func (o GetTenants200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetTenants200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTenants200Response := _GetTenants200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetTenants200Response)

	if err != nil {
		return err
	}

	*o = GetTenants200Response(varGetTenants200Response)
