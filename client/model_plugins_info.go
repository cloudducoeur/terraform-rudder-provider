...
// checks if the PluginsInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PluginsInfo{}

// PluginsInfo struct for PluginsInfo
type PluginsInfo struct {
	GlobalLimits *PluginsInfoGlobalLimits `json:"globalLimits,omitempty"`
	// the list of details for each plugins
	Details []PluginsInfoDetailsInner `json:"details"`
}

type _PluginsInfo PluginsInfo
...
// GetGlobalLimits returns the GlobalLimits field value if set, zero value otherwise.
func (o *PluginsInfo) GetGlobalLimits() PluginsInfoGlobalLimits {
	if o == nil || IsNil(o.GlobalLimits) {
		var ret PluginsInfoGlobalLimits
		return ret
	}
	return *o.GlobalLimits
}

// GetGlobalLimitsOk returns a tuple with the GlobalLimits field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PluginsInfo) GetGlobalLimitsOk() (*PluginsInfoGlobalLimits, bool) {
	if o == nil || IsNil(o.GlobalLimits) {
		return nil, false
	}
	return o.GlobalLimits, true
}
...
// SetGlobalLimits gets a reference to the given PluginsInfoGlobalLimits and assigns it to the GlobalLimits field.
...
func (o *PluginsInfo) GetDetails() []PluginsInfoDetailsInner {
	if o == nil {
		var ret []PluginsInfoDetailsInner
		return ret
	}
...
func (o PluginsInfo) MarshalJSON() ([]byte, error) {
...
func (o PluginsInfo) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.GlobalLimits) {
		toSerialize["globalLimits"] = o.GlobalLimits
	}
	toSerialize["details"] = o.Details
	return toSerialize, nil
}

func (o *PluginsInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varPluginsInfo := _PluginsInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPluginsInfo)

	if err != nil {
		return err
	}

	*o = PluginsInfo(varPluginsInfo)

	return err
}

type NullablePluginsInfo struct {
	value *PluginsInfo
	isSet bool
}

func (v NullablePluginsInfo) Get() *PluginsInfo {
	return v.value
}

func (v *NullablePluginsInfo) Set(val *PluginsInfo) {
	v.value = val
	v.isSet = true
}

func (v NullablePluginsInfo) IsSet() bool {
	return v.isSet
}

func (v *NullablePluginsInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePluginsInfo(val *PluginsInfo) *NullablePluginsInfo {
	return &NullablePluginsInfo{value: val, isSet: true}
}

func (v NullablePluginsInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePluginsInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
