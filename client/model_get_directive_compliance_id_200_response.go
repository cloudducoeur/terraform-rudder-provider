...
// OsFileAsGetDirectiveComplianceId200Response is a convenience function that returns *os.File wrapped in GetDirectiveComplianceId200Response
...
func (dst *GetDirectiveComplianceId200Response) UnmarshalJSON(data []byte) error {
	...
	if err == nil {
		...
		if string(jsonComplianceDirectiveId) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.ComplianceDirectiveId); err != nil {
				dst.ComplianceDirectiveId = nil
			} else {
				match++
			}
...
func (obj GetDirectiveComplianceId200Response) GetActualInstanceValue() interface{} {
	if obj.OsFile != nil {
		return *obj.OsFile
	}
