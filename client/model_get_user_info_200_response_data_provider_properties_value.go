...
// checks if the GetUserInfo200ResponseDataProviderPropertiesValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetUserInfo200ResponseDataProviderPropertiesValue{}

// GetUserInfo200ResponseDataProviderPropertiesValue struct for GetUserInfo200ResponseDataProviderPropertiesValue
type GetUserInfo200ResponseDataProviderPropertiesValue struct {
	RoleListOverride *RoleListOverride `json:"roleListOverride,omitempty"`
}
...
func NewGetUserInfo200ResponseDataProviderPropertiesValue() *GetUserInfo200ResponseDataProviderPropertiesValue {
	this := GetUserInfo200ResponseDataProviderPropertiesValue{}
	return &this
}
...
// GetRoleListOverride returns the RoleListOverride field value if set, zero value otherwise.
func (o *GetUserInfo200ResponseDataProviderPropertiesValue) GetRoleListOverride() RoleListOverride {
	if o == nil || IsNil(o.RoleListOverride) {
		var ret RoleListOverride
		return ret
	}
	return *o.RoleListOverride
}

// GetRoleListOverrideOk returns a tuple with the RoleListOverride field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GetUserInfo200ResponseDataProviderPropertiesValue) GetRoleListOverrideOk() (*RoleListOverride, bool) {
	if o == nil || IsNil(o.RoleListOverride) {
		return nil, false
	}
	return o.RoleListOverride, true
}
...
// SetRoleListOverride gets a reference to the given RoleListOverride and assigns it to the RoleListOverride field.
func (o *GetUserInfo200ResponseDataProviderPropertiesValue) SetRoleListOverride(v RoleListOverride) {
	o.RoleListOverride = &v
}

func (o GetUserInfo200ResponseDataProviderPropertiesValue) MarshalJSON() ([]byte, error) {
...
func (o GetUserInfo200ResponseDataProviderPropertiesValue) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.RoleListOverride) {
		toSerialize["roleListOverride"] = o.RoleListOverride
	}
	return toSerialize, nil
}

type NullableGetUserInfo200ResponseDataProviderPropertiesValue struct {
	value *GetUserInfo200ResponseDataProviderPropertiesValue
	isSet bool
}

func (v NullableGetUserInfo200ResponseDataProviderPropertiesValue) Get() *GetUserInfo200ResponseDataProviderPropertiesValue {
	return v.value
}

func (v *NullableGetUserInfo200ResponseDataProviderPropertiesValue) Set(val *GetUserInfo200ResponseDataProviderPropertiesValue) {
	v.value = val
	v.isSet = true
}

func (v NullableGetUserInfo200ResponseDataProviderPropertiesValue) IsSet() bool {
	return v.isSet
}

func (v *NullableGetUserInfo200ResponseDataProviderPropertiesValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetUserInfo200ResponseDataProviderPropertiesValue(val *GetUserInfo200ResponseDataProviderPropertiesValue) *NullableGetUserInfo200ResponseDataProviderPropertiesValue {
	return &NullableGetUserInfo200ResponseDataProviderPropertiesValue{value: val, isSet: true}
}

func (v NullableGetUserInfo200ResponseDataProviderPropertiesValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetUserInfo200ResponseDataProviderPropertiesValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
