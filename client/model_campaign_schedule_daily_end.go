...
// checks if the CampaignScheduleDailyEnd type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignScheduleDailyEnd{}

// CampaignScheduleDailyEnd Date when the campaign should end
type CampaignScheduleDailyEnd struct {
...
func (o CampaignScheduleDailyEnd) MarshalJSON() ([]byte, error) {
...
func (o CampaignScheduleDailyEnd) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignScheduleDailyEnd struct {
	value *CampaignScheduleDailyEnd
	isSet bool
}

func (v NullableCampaignScheduleDailyEnd) Get() *CampaignScheduleDailyEnd {
	return v.value
}

func (v *NullableCampaignScheduleDailyEnd) Set(val *CampaignScheduleDailyEnd) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignScheduleDailyEnd) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignScheduleDailyEnd) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignScheduleDailyEnd(val *CampaignScheduleDailyEnd) *NullableCampaignScheduleDailyEnd {
	return &NullableCampaignScheduleDailyEnd{value: val, isSet: true}
}

func (v NullableCampaignScheduleDailyEnd) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignScheduleDailyEnd) UnmarshalJSON(src []byte) error {
	v.isSet = true
