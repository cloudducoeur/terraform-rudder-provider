...
// checks if the UpdateUserInfo200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateUserInfo200ResponseData{}

// UpdateUserInfo200ResponseData struct for UpdateUserInfo200ResponseData
type UpdateUserInfo200ResponseData struct {
	UpdatedUser UpdateUserInfo200ResponseDataUpdatedUser `json:"updatedUser"`
}

type _UpdateUserInfo200ResponseData UpdateUserInfo200ResponseData
...
func NewUpdateUserInfo200ResponseData(updatedUser UpdateUserInfo200ResponseDataUpdatedUser) *UpdateUserInfo200ResponseData {
	this := UpdateUserInfo200ResponseData{}
...
func (o *UpdateUserInfo200ResponseData) GetUpdatedUser() UpdateUserInfo200ResponseDataUpdatedUser {
	if o == nil {
		var ret UpdateUserInfo200ResponseDataUpdatedUser
		return ret
	}
...
func (o UpdateUserInfo200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o UpdateUserInfo200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["updatedUser"] = o.UpdatedUser
	return toSerialize, nil
}

func (o *UpdateUserInfo200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateUserInfo200ResponseData := _UpdateUserInfo200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateUserInfo200ResponseData)

	if err != nil {
		return err
	}

	*o = UpdateUserInfo200ResponseData(varUpdateUserInfo200ResponseData)

	return err
}

type NullableUpdateUserInfo200ResponseData struct {
	value *UpdateUserInfo200ResponseData
	isSet bool
}

func (v NullableUpdateUserInfo200ResponseData) Get() *UpdateUserInfo200ResponseData {
	return v.value
}

func (v *NullableUpdateUserInfo200ResponseData) Set(val *UpdateUserInfo200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateUserInfo200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateUserInfo200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateUserInfo200ResponseData(val *UpdateUserInfo200ResponseData) *NullableUpdateUserInfo200ResponseData {
	return &NullableUpdateUserInfo200ResponseData{value: val, isSet: true}
}

func (v NullableUpdateUserInfo200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateUserInfo200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
