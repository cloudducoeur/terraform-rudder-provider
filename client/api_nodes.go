...
func (r ApiChangePendingNodeStatusRequest) Execute() (*ChangePendingNodesStatus200Response, *http.Response, error) {
...
// Execute executes the request
//  @return ChangePendingNodesStatus200Response
func (a *NodesAPIService) ChangePendingNodeStatusExecute(r ApiChangePendingNodeStatusRequest) (*ChangePendingNodesStatus200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ChangePendingNodesStatus200Response
	)
...
type ApiChangePendingNodesStatusRequest struct {
	ctx context.Context
	ApiService *NodesAPIService
	changePendingNodesStatusRequest *ChangePendingNodesStatusRequest
}

func (r ApiChangePendingNodesStatusRequest) ChangePendingNodesStatusRequest(changePendingNodesStatusRequest ChangePendingNodesStatusRequest) ApiChangePendingNodesStatusRequest {
	r.changePendingNodesStatusRequest = &changePendingNodesStatusRequest
	return r
}

func (r ApiChangePendingNodesStatusRequest) Execute() (*ChangePendingNodesStatus200Response, *http.Response, error) {
	return r.ApiService.ChangePendingNodesStatusExecute(r)
}

/*
ChangePendingNodesStatus Update pending nodes status

Accept or refuse one or many pending nodes

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiChangePendingNodesStatusRequest
*/
func (a *NodesAPIService) ChangePendingNodesStatus(ctx context.Context) ApiChangePendingNodesStatusRequest {
	return ApiChangePendingNodesStatusRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ChangePendingNodesStatus200Response
func (a *NodesAPIService) ChangePendingNodesStatusExecute(r ApiChangePendingNodesStatusRequest) (*ChangePendingNodesStatus200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NodesAPIService.ChangePendingNodesStatus")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	// body params
	localVarPostBody = r.changePendingNodesStatusRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["API-Tokens"]; ok {
