...
// checks if the PluginSettings200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PluginSettings200ResponseData{}

// PluginSettings200ResponseData Settings
type PluginSettings200ResponseData struct {
	Plugins []PluginsSettings `json:"plugins"`
}

type _PluginSettings200ResponseData PluginSettings200ResponseData
...
func NewPluginSettings200ResponseData(plugins []PluginsSettings) *PluginSettings200ResponseData {
	this := PluginSettings200ResponseData{}
...
func (o PluginSettings200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o PluginSettings200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["plugins"] = o.Plugins
	return toSerialize, nil
}

func (o *PluginSettings200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varPluginSettings200ResponseData := _PluginSettings200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPluginSettings200ResponseData)

	if err != nil {
		return err
	}

	*o = PluginSettings200ResponseData(varPluginSettings200ResponseData)

	return err
}

type NullablePluginSettings200ResponseData struct {
	value *PluginSettings200ResponseData
	isSet bool
}

func (v NullablePluginSettings200ResponseData) Get() *PluginSettings200ResponseData {
	return v.value
}

func (v *NullablePluginSettings200ResponseData) Set(val *PluginSettings200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullablePluginSettings200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullablePluginSettings200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePluginSettings200ResponseData(val *PluginSettings200ResponseData) *NullablePluginSettings200ResponseData {
	return &NullablePluginSettings200ResponseData{value: val, isSet: true}
}

func (v NullablePluginSettings200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePluginSettings200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
