...
// checks if the GroupRuleComplianceDirectivesComponentsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupRuleComplianceDirectivesComponentsInner{}

// GroupRuleComplianceDirectivesComponentsInner struct for GroupRuleComplianceDirectivesComponentsInner
type GroupRuleComplianceDirectivesComponentsInner struct {
...
type _GroupRuleComplianceDirectivesComponentsInner GroupRuleComplianceDirectivesComponentsInner
...
func NewGroupRuleComplianceDirectivesComponentsInner(name string, compliance float32, complianceDetails RuleComplianceComponentComplianceDetails, nodes []NodeComplianceComponent) *GroupRuleComplianceDirectivesComponentsInner {
	this := GroupRuleComplianceDirectivesComponentsInner{}
	this.Name = name
...
func (o GroupRuleComplianceDirectivesComponentsInner) MarshalJSON() ([]byte, error) {
...
func (o GroupRuleComplianceDirectivesComponentsInner) ToMap() (map[string]interface{}, error) {
...
func (o *GroupRuleComplianceDirectivesComponentsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varGroupRuleComplianceDirectivesComponentsInner := _GroupRuleComplianceDirectivesComponentsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGroupRuleComplianceDirectivesComponentsInner)

	if err != nil {
		return err
	}

	*o = GroupRuleComplianceDirectivesComponentsInner(varGroupRuleComplianceDirectivesComponentsInner)

	return err
}

type NullableGroupRuleComplianceDirectivesComponentsInner struct {
	value *GroupRuleComplianceDirectivesComponentsInner
	isSet bool
}

func (v NullableGroupRuleComplianceDirectivesComponentsInner) Get() *GroupRuleComplianceDirectivesComponentsInner {
	return v.value
}

func (v *NullableGroupRuleComplianceDirectivesComponentsInner) Set(val *GroupRuleComplianceDirectivesComponentsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupRuleComplianceDirectivesComponentsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupRuleComplianceDirectivesComponentsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupRuleComplianceDirectivesComponentsInner(val *GroupRuleComplianceDirectivesComponentsInner) *NullableGroupRuleComplianceDirectivesComponentsInner {
	return &NullableGroupRuleComplianceDirectivesComponentsInner{value: val, isSet: true}
}

func (v NullableGroupRuleComplianceDirectivesComponentsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupRuleComplianceDirectivesComponentsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
