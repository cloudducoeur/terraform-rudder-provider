...
// checks if the ChangePendingNodesStatus200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangePendingNodesStatus200Response{}

// ChangePendingNodesStatus200Response struct for ChangePendingNodesStatus200Response
type ChangePendingNodesStatus200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data ChangePendingNodesStatus200ResponseData `json:"data"`
}

type _ChangePendingNodesStatus200Response ChangePendingNodesStatus200Response
...
func NewChangePendingNodesStatus200Response(result string, action string, data ChangePendingNodesStatus200ResponseData) *ChangePendingNodesStatus200Response {
	this := ChangePendingNodesStatus200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *ChangePendingNodesStatus200Response) GetData() ChangePendingNodesStatus200ResponseData {
	if o == nil {
		var ret ChangePendingNodesStatus200ResponseData
		return ret
	}
...
func (o ChangePendingNodesStatus200Response) MarshalJSON() ([]byte, error) {
...
func (o ChangePendingNodesStatus200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ChangePendingNodesStatus200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varChangePendingNodesStatus200Response := _ChangePendingNodesStatus200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varChangePendingNodesStatus200Response)

	if err != nil {
		return err
	}

	*o = ChangePendingNodesStatus200Response(varChangePendingNodesStatus200Response)

	return err
}

type NullableChangePendingNodesStatus200Response struct {
	value *ChangePendingNodesStatus200Response
	isSet bool
}

func (v NullableChangePendingNodesStatus200Response) Get() *ChangePendingNodesStatus200Response {
	return v.value
}

func (v *NullableChangePendingNodesStatus200Response) Set(val *ChangePendingNodesStatus200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableChangePendingNodesStatus200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableChangePendingNodesStatus200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangePendingNodesStatus200Response(val *ChangePendingNodesStatus200Response) *NullableChangePendingNodesStatus200Response {
	return &NullableChangePendingNodesStatus200Response{value: val, isSet: true}
}

func (v NullableChangePendingNodesStatus200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangePendingNodesStatus200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
