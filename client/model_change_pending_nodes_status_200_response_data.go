...
// checks if the ChangePendingNodesStatus200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangePendingNodesStatus200ResponseData{}

// ChangePendingNodesStatus200ResponseData Information about the node
type ChangePendingNodesStatus200ResponseData struct {
	Nodes []NodePendingResult `json:"nodes"`
}

type _ChangePendingNodesStatus200ResponseData ChangePendingNodesStatus200ResponseData
...
func NewChangePendingNodesStatus200ResponseData(nodes []NodePendingResult) *ChangePendingNodesStatus200ResponseData {
	this := ChangePendingNodesStatus200ResponseData{}
	this.Nodes = nodes
	return &this
}
...
func (o ChangePendingNodesStatus200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o ChangePendingNodesStatus200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["nodes"] = o.Nodes
	return toSerialize, nil
}

func (o *ChangePendingNodesStatus200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varChangePendingNodesStatus200ResponseData := _ChangePendingNodesStatus200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varChangePendingNodesStatus200ResponseData)

	if err != nil {
		return err
	}

	*o = ChangePendingNodesStatus200ResponseData(varChangePendingNodesStatus200ResponseData)

	return err
}

type NullableChangePendingNodesStatus200ResponseData struct {
	value *ChangePendingNodesStatus200ResponseData
	isSet bool
}

func (v NullableChangePendingNodesStatus200ResponseData) Get() *ChangePendingNodesStatus200ResponseData {
	return v.value
}

func (v *NullableChangePendingNodesStatus200ResponseData) Set(val *ChangePendingNodesStatus200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableChangePendingNodesStatus200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableChangePendingNodesStatus200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangePendingNodesStatus200ResponseData(val *ChangePendingNodesStatus200ResponseData) *NullableChangePendingNodesStatus200ResponseData {
	return &NullableChangePendingNodesStatus200ResponseData{value: val, isSet: true}
}

func (v NullableChangePendingNodesStatus200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangePendingNodesStatus200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
