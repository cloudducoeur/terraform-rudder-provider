...
// checks if the PluginsInfoDetailsInnerLicense type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PluginsInfoDetailsInnerLicense{}

// PluginsInfoDetailsInnerLicense information about the plugin
type PluginsInfoDetailsInnerLicense struct {
	// name of the licensee for that plugin
	Licensee *string `json:"licensee,omitempty"`
	// the fully qualified name of the plugin for which that license was issued
	SoftwareId *string `json:"softwareId,omitempty"`
	// lowest version of the software for which that license is valid
	MinVersion *string `json:"minVersion,omitempty"`
	// highest version of the software for which that license is valid
	MaxVersion *string `json:"maxVersion,omitempty"`
	// start of validity date
	StartDate *string `json:"startDate,omitempty"`
	// end of validity date
	EndDate *string `json:"endDate,omitempty"`
	// maximum number of node in Rudder for that license
...
func NewPluginsInfoDetailsInnerLicense() *PluginsInfoDetailsInnerLicense {
	this := PluginsInfoDetailsInnerLicense{}
	return &this
}
...
// GetLicensee returns the Licensee field value if set, zero value otherwise.
func (o *PluginsInfoDetailsInnerLicense) GetLicensee() string {
	if o == nil || IsNil(o.Licensee) {
		var ret string
		return ret
	}
	return *o.Licensee
...
// GetLicenseeOk returns a tuple with the Licensee field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PluginsInfoDetailsInnerLicense) GetLicenseeOk() (*string, bool) {
	if o == nil || IsNil(o.Licensee) {
		return nil, false
	}
	return o.Licensee, true
}
...
// SetLicensee gets a reference to the given string and assigns it to the Licensee field.
...
func (o PluginsInfoDetailsInnerLicense) MarshalJSON() ([]byte, error) {
...
func (o PluginsInfoDetailsInnerLicense) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Licensee) {
		toSerialize["licensee"] = o.Licensee
	}
...
type NullablePluginsInfoDetailsInnerLicense struct {
	value *PluginsInfoDetailsInnerLicense
	isSet bool
}

func (v NullablePluginsInfoDetailsInnerLicense) Get() *PluginsInfoDetailsInnerLicense {
	return v.value
}

func (v *NullablePluginsInfoDetailsInnerLicense) Set(val *PluginsInfoDetailsInnerLicense) {
	v.value = val
	v.isSet = true
}

func (v NullablePluginsInfoDetailsInnerLicense) IsSet() bool {
	return v.isSet
}

func (v *NullablePluginsInfoDetailsInnerLicense) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePluginsInfoDetailsInnerLicense(val *PluginsInfoDetailsInnerLicense) *NullablePluginsInfoDetailsInnerLicense {
	return &NullablePluginsInfoDetailsInnerLicense{value: val, isSet: true}
}

func (v NullablePluginsInfoDetailsInnerLicense) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePluginsInfoDetailsInnerLicense) UnmarshalJSON(src []byte) error {
	v.isSet = true
