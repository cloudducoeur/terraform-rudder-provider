...
// checks if the PluginSettings200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PluginSettings200Response{}

// PluginSettings200Response struct for PluginSettings200Response
type PluginSettings200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data PluginSettings200ResponseData `json:"data"`
}

type _PluginSettings200Response PluginSettings200Response
...
func NewPluginSettings200Response(result string, action string, data PluginSettings200ResponseData) *PluginSettings200Response {
	this := PluginSettings200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *PluginSettings200Response) GetData() PluginSettings200ResponseData {
	if o == nil {
		var ret PluginSettings200ResponseData
		return ret
	}
...
func (o PluginSettings200Response) MarshalJSON() ([]byte, error) {
...
func (o PluginSettings200Response) ToMap() (map[string]interface{}, error) {
...
func (o *PluginSettings200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varPluginSettings200Response := _PluginSettings200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPluginSettings200Response)

	if err != nil {
		return err
	}

	*o = PluginSettings200Response(varPluginSettings200Response)

	return err
}

type NullablePluginSettings200Response struct {
	value *PluginSettings200Response
	isSet bool
}

func (v NullablePluginSettings200Response) Get() *PluginSettings200Response {
	return v.value
}

func (v *NullablePluginSettings200Response) Set(val *PluginSettings200Response) {
	v.value = val
	v.isSet = true
}

func (v NullablePluginSettings200Response) IsSet() bool {
	return v.isSet
}

func (v *NullablePluginSettings200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePluginSettings200Response(val *PluginSettings200Response) *NullablePluginSettings200Response {
	return &NullablePluginSettings200Response{value: val, isSet: true}
}

func (v NullablePluginSettings200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePluginSettings200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
