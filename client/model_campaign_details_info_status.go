...
func (dst *CampaignDetailsInfoStatus) UnmarshalJSON(data []byte) error {
	...
	if err == nil {
		...
		if string(jsonCampaignStatusArchived) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.CampaignStatusArchived); err != nil {
				dst.CampaignStatusArchived = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonCampaignStatusDisabled) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.CampaignStatusDisabled); err != nil {
				dst.CampaignStatusDisabled = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonCampaignStatusEnabled) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.CampaignStatusEnabled); err != nil {
				dst.CampaignStatusEnabled = nil
			} else {
				match++
			}
...
func (obj CampaignDetailsInfoStatus) GetActualInstanceValue() (interface{}) {
	if obj.CampaignStatusArchived != nil {
		return *obj.CampaignStatusArchived
	}
