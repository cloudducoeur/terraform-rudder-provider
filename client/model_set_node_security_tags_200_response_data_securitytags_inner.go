...
// checks if the SetNodeSecurityTags200ResponseDataSecuritytagsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SetNodeSecurityTags200ResponseDataSecuritytagsInner{}

// SetNodeSecurityTags200ResponseDataSecuritytagsInner struct for SetNodeSecurityTags200ResponseDataSecuritytagsInner
type SetNodeSecurityTags200ResponseDataSecuritytagsInner struct {
	// the ID of the tenant set on nodes
	TenantId string `json:"tenantId"`
	NodeIds []string `json:"nodeIds"`
}

type _SetNodeSecurityTags200ResponseDataSecuritytagsInner SetNodeSecurityTags200ResponseDataSecuritytagsInner
...
func NewSetNodeSecurityTags200ResponseDataSecuritytagsInner(tenantId string, nodeIds []string) *SetNodeSecurityTags200ResponseDataSecuritytagsInner {
	this := SetNodeSecurityTags200ResponseDataSecuritytagsInner{}
...
func (o SetNodeSecurityTags200ResponseDataSecuritytagsInner) MarshalJSON() ([]byte, error) {
...
func (o SetNodeSecurityTags200ResponseDataSecuritytagsInner) ToMap() (map[string]interface{}, error) {
...
func (o *SetNodeSecurityTags200ResponseDataSecuritytagsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varSetNodeSecurityTags200ResponseDataSecuritytagsInner := _SetNodeSecurityTags200ResponseDataSecuritytagsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSetNodeSecurityTags200ResponseDataSecuritytagsInner)

	if err != nil {
		return err
	}

	*o = SetNodeSecurityTags200ResponseDataSecuritytagsInner(varSetNodeSecurityTags200ResponseDataSecuritytagsInner)

	return err
}

type NullableSetNodeSecurityTags200ResponseDataSecuritytagsInner struct {
	value *SetNodeSecurityTags200ResponseDataSecuritytagsInner
	isSet bool
}

func (v NullableSetNodeSecurityTags200ResponseDataSecuritytagsInner) Get() *SetNodeSecurityTags200ResponseDataSecuritytagsInner {
	return v.value
}

func (v *NullableSetNodeSecurityTags200ResponseDataSecuritytagsInner) Set(val *SetNodeSecurityTags200ResponseDataSecuritytagsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSetNodeSecurityTags200ResponseDataSecuritytagsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSetNodeSecurityTags200ResponseDataSecuritytagsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSetNodeSecurityTags200ResponseDataSecuritytagsInner(val *SetNodeSecurityTags200ResponseDataSecuritytagsInner) *NullableSetNodeSecurityTags200ResponseDataSecuritytagsInner {
	return &NullableSetNodeSecurityTags200ResponseDataSecuritytagsInner{value: val, isSet: true}
}

func (v NullableSetNodeSecurityTags200ResponseDataSecuritytagsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSetNodeSecurityTags200ResponseDataSecuritytagsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
