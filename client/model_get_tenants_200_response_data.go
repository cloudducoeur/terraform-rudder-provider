...
// checks if the GetTenants200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTenants200ResponseData{}

// GetTenants200ResponseData struct for GetTenants200ResponseData
type GetTenants200ResponseData struct {
	Tenants []Tenant `json:"tenants"`
}

type _GetTenants200ResponseData GetTenants200ResponseData

// NewGetTenants200ResponseData instantiates a new GetTenants200ResponseData object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetTenants200ResponseData(tenants []Tenant) *GetTenants200ResponseData {
	this := GetTenants200ResponseData{}
	this.Tenants = tenants
	return &this
}

// NewGetTenants200ResponseDataWithDefaults instantiates a new GetTenants200ResponseData object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGetTenants200ResponseDataWithDefaults() *GetTenants200ResponseData {
	this := GetTenants200ResponseData{}
	return &this
}

// GetTenants returns the Tenants field value
func (o *GetTenants200ResponseData) GetTenants() []Tenant {
	if o == nil {
		var ret []Tenant
		return ret
	}
...
func (o *GetTenants200ResponseData) GetTenantsOk() ([]Tenant, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetTenants200ResponseData) SetTenants(v []Tenant) {
	o.Tenants = v
}

func (o GetTenants200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetTenants200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["tenants"] = o.Tenants
	return toSerialize, nil
}

func (o *GetTenants200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTenants200ResponseData := _GetTenants200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetTenants200ResponseData)

	if err != nil {
		return err
	}

	*o = GetTenants200ResponseData(varGetTenants200ResponseData)

	return err
}

type NullableGetTenants200ResponseData struct {
	value *GetTenants200ResponseData
	isSet bool
}

func (v NullableGetTenants200ResponseData) Get() *GetTenants200ResponseData {
	return v.value
}

func (v *NullableGetTenants200ResponseData) Set(val *GetTenants200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTenants200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTenants200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTenants200ResponseData(val *GetTenants200ResponseData) *NullableGetTenants200ResponseData {
	return &NullableGetTenants200ResponseData{value: val, isSet: true}
}

func (v NullableGetTenants200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTenants200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
