...
// checks if the DisableUser500Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DisableUser500Response{}

// DisableUser500Response struct for DisableUser500Response
type DisableUser500Response struct {
...
type _DisableUser500Response DisableUser500Response
...
func (o DisableUser500Response) MarshalJSON() ([]byte, error) {
...
func (o DisableUser500Response) ToMap() (map[string]interface{}, error) {
...
func (o *DisableUser500Response) UnmarshalJSON(data []byte) (err error) {
	...
	varDisableUser500Response := _DisableUser500Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDisableUser500Response)

	if err != nil {
		return err
	}

	*o = DisableUser500Response(varDisableUser500Response)

	return err
}

type NullableDisableUser500Response struct {
	value *DisableUser500Response
	isSet bool
}

func (v NullableDisableUser500Response) Get() *DisableUser500Response {
	return v.value
}

func (v *NullableDisableUser500Response) Set(val *DisableUser500Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDisableUser500Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDisableUser500Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDisableUser500Response(val *DisableUser500Response) *NullableDisableUser500Response {
	return &NullableDisableUser500Response{value: val, isSet: true}
}

func (v NullableDisableUser500Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDisableUser500Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
