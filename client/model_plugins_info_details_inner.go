...
// checks if the PluginsInfoDetailsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PluginsInfoDetailsInner{}

// PluginsInfoDetailsInner struct for PluginsInfoDetailsInner
type PluginsInfoDetailsInner struct {
	...
	// status of the plugin, enabled or disabled
	Status *string `json:"status,omitempty"`
	// a message explaining the status when disabled
	StatusMessage *string `json:"statusMessage,omitempty"`
	License *PluginsInfoDetailsInnerLicense `json:"license,omitempty"`
}
...
func (o *PluginsInfoDetailsInner) SetId(v string) {
	o.Id = &v
}
...
func (o *PluginsInfoDetailsInner) GetLicense() PluginsInfoDetailsInnerLicense {
	if o == nil || IsNil(o.License) {
		var ret PluginsInfoDetailsInnerLicense
		return ret
	}
	return *o.License
}
...
// SetLicense gets a reference to the given PluginsInfoDetailsInnerLicense and assigns it to the License field.
func (o *PluginsInfoDetailsInner) SetLicense(v PluginsInfoDetailsInnerLicense) {
	o.License = &v
}

func (o PluginsInfoDetailsInner) MarshalJSON() ([]byte, error) {
...
func (o PluginsInfoDetailsInner) ToMap() (map[string]interface{}, error) {
...
type NullablePluginsInfoDetailsInner struct {
	value *PluginsInfoDetailsInner
	isSet bool
}

func (v NullablePluginsInfoDetailsInner) Get() *PluginsInfoDetailsInner {
	return v.value
}

func (v *NullablePluginsInfoDetailsInner) Set(val *PluginsInfoDetailsInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePluginsInfoDetailsInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePluginsInfoDetailsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePluginsInfoDetailsInner(val *PluginsInfoDetailsInner) *NullablePluginsInfoDetailsInner {
	return &NullablePluginsInfoDetailsInner{value: val, isSet: true}
}

func (v NullablePluginsInfoDetailsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePluginsInfoDetailsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
