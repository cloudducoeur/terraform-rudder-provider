...
// checks if the DeleteTenants200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteTenants200Response{}

// DeleteTenants200Response struct for DeleteTenants200Response
type DeleteTenants200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data DeleteTenants200ResponseData `json:"data"`
}

type _DeleteTenants200Response DeleteTenants200Response
...
func (o *DeleteTenants200Response) GetData() DeleteTenants200ResponseData {
	if o == nil {
		var ret DeleteTenants200ResponseData
		return ret
	}
...
func (o DeleteTenants200Response) MarshalJSON() ([]byte, error) {
...
func (o DeleteTenants200Response) ToMap() (map[string]interface{}, error) {
...
func (o *DeleteTenants200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteTenants200Response := _DeleteTenants200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteTenants200Response)

	if err != nil {
		return err
	}

	*o = DeleteTenants200Response(varDeleteTenants200Response)

	return err
}

type NullableDeleteTenants200Response struct {
	value *DeleteTenants200Response
	isSet bool
}

func (v NullableDeleteTenants200Response) Get() *DeleteTenants200Response {
	return v.value
}

func (v *NullableDeleteTenants200Response) Set(val *DeleteTenants200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteTenants200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteTenants200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteTenants200Response(val *DeleteTenants200Response) *NullableDeleteTenants200Response {
	return &NullableDeleteTenants200Response{value: val, isSet: true}
}

func (v NullableDeleteTenants200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteTenants200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
