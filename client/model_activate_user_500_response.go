...
// checks if the ActivateUser500Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActivateUser500Response{}

// ActivateUser500Response struct for ActivateUser500Response
type ActivateUser500Response struct {
...
type _ActivateUser500Response ActivateUser500Response
...
func (o ActivateUser500Response) MarshalJSON() ([]byte, error) {
...
func (o ActivateUser500Response) ToMap() (map[string]interface{}, error) {
...
func (o *ActivateUser500Response) UnmarshalJSON(data []byte) (err error) {
	...
	varActivateUser500Response := _ActivateUser500Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varActivateUser500Response)

	if err != nil {
		return err
	}

	*o = ActivateUser500Response(varActivateUser500Response)

	return err
}

type NullableActivateUser500Response struct {
	value *ActivateUser500Response
	isSet bool
}

func (v NullableActivateUser500Response) Get() *ActivateUser500Response {
	return v.value
}

func (v *NullableActivateUser500Response) Set(val *ActivateUser500Response) {
	v.value = val
	v.isSet = true
}

func (v NullableActivateUser500Response) IsSet() bool {
	return v.isSet
}

func (v *NullableActivateUser500Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActivateUser500Response(val *ActivateUser500Response) *NullableActivateUser500Response {
	return &NullableActivateUser500Response{value: val, isSet: true}
}

func (v NullableActivateUser500Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActivateUser500Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
