...
// checks if the GroupRuleComplianceDirectives type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupRuleComplianceDirectives{}

// GroupRuleComplianceDirectives struct for GroupRuleComplianceDirectives
type GroupRuleComplianceDirectives struct {
	// id of the directive
	Id string `json:"id"`
	// Name of the directive
	Name string `json:"name"`
	// Policy mode of the rule
	...
	Components []GroupRuleComplianceDirectivesComponentsInner `json:"components"`
}

type _GroupRuleComplianceDirectives GroupRuleComplianceDirectives
...
func NewGroupRuleComplianceDirectives(id string, name string, policyMode string, compliance float32, complianceDetails GetDirectivesCompliance200ResponseDataDirectivesComplianceComplianceDetails, components []GroupRuleComplianceDirectivesComponentsInner) *GroupRuleComplianceDirectives {
	this := GroupRuleComplianceDirectives{}
	this.Id = id
	this.Name = name
...
func (o *GroupRuleComplianceDirectives) GetComponents() []GroupRuleComplianceDirectivesComponentsInner {
	if o == nil {
		var ret []GroupRuleComplianceDirectivesComponentsInner
		return ret
	}
...
func (o GroupRuleComplianceDirectives) MarshalJSON() ([]byte, error) {
...
func (o GroupRuleComplianceDirectives) ToMap() (map[string]interface{}, error) {
...
func (o *GroupRuleComplianceDirectives) UnmarshalJSON(data []byte) (err error) {
	...
	varGroupRuleComplianceDirectives := _GroupRuleComplianceDirectives{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGroupRuleComplianceDirectives)

	if err != nil {
		return err
	}

	*o = GroupRuleComplianceDirectives(varGroupRuleComplianceDirectives)

	return err
}

type NullableGroupRuleComplianceDirectives struct {
	value *GroupRuleComplianceDirectives
	isSet bool
}

func (v NullableGroupRuleComplianceDirectives) Get() *GroupRuleComplianceDirectives {
	return v.value
}

func (v *NullableGroupRuleComplianceDirectives) Set(val *GroupRuleComplianceDirectives) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupRuleComplianceDirectives) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupRuleComplianceDirectives) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupRuleComplianceDirectives(val *GroupRuleComplianceDirectives) *NullableGroupRuleComplianceDirectives {
	return &NullableGroupRuleComplianceDirectives{value: val, isSet: true}
}

func (v NullableGroupRuleComplianceDirectives) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupRuleComplianceDirectives) UnmarshalJSON(src []byte) error {
	v.isSet = true
