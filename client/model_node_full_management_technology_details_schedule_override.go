...
// checks if the NodeFullManagementTechnologyDetailsScheduleOverride type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeFullManagementTechnologyDetailsScheduleOverride{}

// NodeFullManagementTechnologyDetailsScheduleOverride Node agent run specific run schedule
type NodeFullManagementTechnologyDetailsScheduleOverride struct {
	// duration of run interval, formatted with a time unit
	RunInterval *string `json:"runInterval,omitempty"`
	// time of the first run in HH:mm format
	FirstRun *string `json:"firstRun,omitempty"`
	// duration of the configured splay time with a time unit
	SplayTime *string `json:"splayTime,omitempty"`
}
...
func NewNodeFullManagementTechnologyDetailsScheduleOverride() *NodeFullManagementTechnologyDetailsScheduleOverride {
	this := NodeFullManagementTechnologyDetailsScheduleOverride{}
	return &this
}
...
// GetRunInterval returns the RunInterval field value if set, zero value otherwise.
func (o *NodeFullManagementTechnologyDetailsScheduleOverride) GetRunInterval() string {
	if o == nil || IsNil(o.RunInterval) {
		var ret string
		return ret
	}
	return *o.RunInterval
}

// GetRunIntervalOk returns a tuple with the RunInterval field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NodeFullManagementTechnologyDetailsScheduleOverride) GetRunIntervalOk() (*string, bool) {
	if o == nil || IsNil(o.RunInterval) {
		return nil, false
	}
	return o.RunInterval, true
}
...
// SetRunInterval gets a reference to the given string and assigns it to the RunInterval field.
func (o *NodeFullManagementTechnologyDetailsScheduleOverride) SetRunInterval(v string) {
	o.RunInterval = &v
}

// GetFirstRun returns the FirstRun field value if set, zero value otherwise.
func (o *NodeFullManagementTechnologyDetailsScheduleOverride) GetFirstRun() string {
	if o == nil || IsNil(o.FirstRun) {
		var ret string
		return ret
	}
	return *o.FirstRun
...
// GetFirstRunOk returns a tuple with the FirstRun field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NodeFullManagementTechnologyDetailsScheduleOverride) GetFirstRunOk() (*string, bool) {
	if o == nil || IsNil(o.FirstRun) {
		return nil, false
	}
	return o.FirstRun, true
}
...
// SetFirstRun gets a reference to the given string and assigns it to the FirstRun field.
...
// SetSplayTime gets a reference to the given string and assigns it to the SplayTime field.
func (o *NodeFullManagementTechnologyDetailsScheduleOverride) SetSplayTime(v string) {
	o.SplayTime = &v
}

func (o NodeFullManagementTechnologyDetailsScheduleOverride) MarshalJSON() ([]byte, error) {
...
func (o NodeFullManagementTechnologyDetailsScheduleOverride) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.RunInterval) {
		toSerialize["runInterval"] = o.RunInterval
	}
	if !IsNil(o.FirstRun) {
		toSerialize["firstRun"] = o.FirstRun
	}
	if !IsNil(o.SplayTime) {
		toSerialize["splayTime"] = o.SplayTime
	}
	return toSerialize, nil
}

type NullableNodeFullManagementTechnologyDetailsScheduleOverride struct {
	value *NodeFullManagementTechnologyDetailsScheduleOverride
	isSet bool
}

func (v NullableNodeFullManagementTechnologyDetailsScheduleOverride) Get() *NodeFullManagementTechnologyDetailsScheduleOverride {
	return v.value
}

func (v *NullableNodeFullManagementTechnologyDetailsScheduleOverride) Set(val *NodeFullManagementTechnologyDetailsScheduleOverride) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeFullManagementTechnologyDetailsScheduleOverride) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeFullManagementTechnologyDetailsScheduleOverride) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeFullManagementTechnologyDetailsScheduleOverride(val *NodeFullManagementTechnologyDetailsScheduleOverride) *NullableNodeFullManagementTechnologyDetailsScheduleOverride {
	return &NullableNodeFullManagementTechnologyDetailsScheduleOverride{value: val, isSet: true}
}

func (v NullableNodeFullManagementTechnologyDetailsScheduleOverride) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeFullManagementTechnologyDetailsScheduleOverride) UnmarshalJSON(src []byte) error {
	v.isSet = true
