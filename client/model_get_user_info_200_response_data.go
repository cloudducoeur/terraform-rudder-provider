...
type GetUserInfo200ResponseData struct {
	RoleListOverride RoleListOverride `json:"roleListOverride"`
	AuthenticationBackends []string `json:"authenticationBackends"`
	ProviderProperties map[string]GetUserInfo200ResponseDataProviderPropertiesValue `json:"providerProperties"`
	Users []User `json:"users"`
	// Default password hash algorithm
	Digest string `json:"digest"`
	// Whether the tenants plugin is enabled or not, indicating if users only belong to their assigned tenants
	TenantsEnabled bool `json:"tenantsEnabled"`
}
...
func NewGetUserInfo200ResponseData(roleListOverride RoleListOverride, authenticationBackends []string, providerProperties map[string]GetUserInfo200ResponseDataProviderPropertiesValue, users []User, digest string, tenantsEnabled bool) *GetUserInfo200ResponseData {
	...
	this.RoleListOverride = roleListOverride
	this.AuthenticationBackends = authenticationBackends
...
// GetRoleListOverride returns the RoleListOverride field value
...
// GetRoleListOverrideOk returns a tuple with the RoleListOverride field value
...
// SetRoleListOverride sets field value
func (o *GetUserInfo200ResponseData) SetRoleListOverride(v RoleListOverride) {
	o.RoleListOverride = v
}

// GetAuthenticationBackends returns the AuthenticationBackends field value
func (o *GetUserInfo200ResponseData) GetAuthenticationBackends() []string {
	...
	return o.AuthenticationBackends
}

// GetAuthenticationBackendsOk returns a tuple with the AuthenticationBackends field value
// and a boolean to check if the value has been set.
func (o *GetUserInfo200ResponseData) GetAuthenticationBackendsOk() ([]string, bool) {
	if o == nil {
		return nil, false
	}
	return o.AuthenticationBackends, true
}

// SetAuthenticationBackends sets field value
func (o *GetUserInfo200ResponseData) SetAuthenticationBackends(v []string) {
	o.AuthenticationBackends = v
}

// GetProviderProperties returns the ProviderProperties field value
func (o *GetUserInfo200ResponseData) GetProviderProperties() map[string]GetUserInfo200ResponseDataProviderPropertiesValue {
	if o == nil {
		var ret map[string]GetUserInfo200ResponseDataProviderPropertiesValue
		return ret
	}
...
// GetProviderPropertiesOk returns a tuple with the ProviderProperties field value
// and a boolean to check if the value has been set.
func (o *GetUserInfo200ResponseData) GetProviderPropertiesOk() (map[string]GetUserInfo200ResponseDataProviderPropertiesValue, bool) {
	if o == nil {
		return map[string]GetUserInfo200ResponseDataProviderPropertiesValue{}, false
	}
	return o.ProviderProperties, true
}

// SetProviderProperties sets field value
...
// GetTenantsEnabled returns the TenantsEnabled field value
func (o *GetUserInfo200ResponseData) GetTenantsEnabled() bool {
	...
	return o.TenantsEnabled
}

// GetTenantsEnabledOk returns a tuple with the TenantsEnabled field value
// and a boolean to check if the value has been set.
func (o *GetUserInfo200ResponseData) GetTenantsEnabledOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.TenantsEnabled, true
}

// SetTenantsEnabled sets field value
...
func (o GetUserInfo200ResponseData) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["authenticationBackends"] = o.AuthenticationBackends
	toSerialize["providerProperties"] = o.ProviderProperties
	toSerialize["users"] = o.Users
	toSerialize["digest"] = o.Digest
	toSerialize["tenantsEnabled"] = o.TenantsEnabled
