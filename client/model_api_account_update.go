...
// checks if the ApiAccountUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiAccountUpdate{}

// ApiAccountUpdate struct for ApiAccountUpdate
type ApiAccountUpdate struct {
	...
	Acl []ApiAccountNewAclInner `json:"acl,omitempty"`
}
...
// SetAcl gets a reference to the given []ApiAccountNewAclInner and assigns it to the Acl field.
func (o *ApiAccountUpdate) SetAcl(v []ApiAccountNewAclInner) {
	o.Acl = v
}

func (o ApiAccountUpdate) MarshalJSON() ([]byte, error) {
...
func (o ApiAccountUpdate) ToMap() (map[string]interface{}, error) {
...
type NullableApiAccountUpdate struct {
	value *ApiAccountUpdate
	isSet bool
}

func (v NullableApiAccountUpdate) Get() *ApiAccountUpdate {
	return v.value
}

func (v *NullableApiAccountUpdate) Set(val *ApiAccountUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableApiAccountUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableApiAccountUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiAccountUpdate(val *ApiAccountUpdate) *NullableApiAccountUpdate {
	return &NullableApiAccountUpdate{value: val, isSet: true}
}

func (v NullableApiAccountUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiAccountUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
