...
// checks if the RoleCoverage200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoleCoverage200Response{}

// RoleCoverage200Response struct for RoleCoverage200Response
type RoleCoverage200Response struct {
	// The id of the action
	Action string `json:"action"`
	// Result of the request
	Result string `json:"result"`
	Data RoleCoverage200ResponseData `json:"data"`
}

type _RoleCoverage200Response RoleCoverage200Response
...
func (o *RoleCoverage200Response) GetData() RoleCoverage200ResponseData {
	if o == nil {
		var ret RoleCoverage200ResponseData
		return ret
	}
...
func (o RoleCoverage200Response) MarshalJSON() ([]byte, error) {
...
func (o RoleCoverage200Response) ToMap() (map[string]interface{}, error) {
...
func (o *RoleCoverage200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varRoleCoverage200Response := _RoleCoverage200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRoleCoverage200Response)

	if err != nil {
		return err
	}

	*o = RoleCoverage200Response(varRoleCoverage200Response)

	return err
}

type NullableRoleCoverage200Response struct {
	value *RoleCoverage200Response
	isSet bool
}

func (v NullableRoleCoverage200Response) Get() *RoleCoverage200Response {
	return v.value
}

func (v *NullableRoleCoverage200Response) Set(val *RoleCoverage200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableRoleCoverage200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableRoleCoverage200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoleCoverage200Response(val *RoleCoverage200Response) *NullableRoleCoverage200Response {
	return &NullableRoleCoverage200Response{value: val, isSet: true}
}

func (v NullableRoleCoverage200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoleCoverage200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
