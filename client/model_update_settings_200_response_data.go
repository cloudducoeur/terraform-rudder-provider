...
// checks if the UpdateSettings200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateSettings200ResponseData{}

// UpdateSettings200ResponseData Parameters
type UpdateSettings200ResponseData struct {
	Parameters []PluginsSettings `json:"parameters,omitempty"`
}
...
func NewUpdateSettings200ResponseData() *UpdateSettings200ResponseData {
	this := UpdateSettings200ResponseData{}
	return &this
}
...
// SetParameters gets a reference to the given []PluginsSettings and assigns it to the Parameters field.
func (o *UpdateSettings200ResponseData) SetParameters(v []PluginsSettings) {
	o.Parameters = v
}

func (o UpdateSettings200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o UpdateSettings200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateSettings200ResponseData struct {
	value *UpdateSettings200ResponseData
	isSet bool
}

func (v NullableUpdateSettings200ResponseData) Get() *UpdateSettings200ResponseData {
	return v.value
}

func (v *NullableUpdateSettings200ResponseData) Set(val *UpdateSettings200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateSettings200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateSettings200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateSettings200ResponseData(val *UpdateSettings200ResponseData) *NullableUpdateSettings200ResponseData {
	return &NullableUpdateSettings200ResponseData{value: val, isSet: true}
}

func (v NullableUpdateSettings200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateSettings200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
