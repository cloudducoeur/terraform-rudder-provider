...
// checks if the NodePendingResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodePendingResult{}

// NodePendingResult struct for NodePendingResult
type NodePendingResult struct {
...
type _NodePendingResult NodePendingResult
...
func (o NodePendingResult) MarshalJSON() ([]byte, error) {
...
func (o NodePendingResult) ToMap() (map[string]interface{}, error) {
...
func (o *NodePendingResult) UnmarshalJSON(data []byte) (err error) {
	...
	varNodePendingResult := _NodePendingResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNodePendingResult)

	if err != nil {
		return err
	}

	*o = NodePendingResult(varNodePendingResult)

	return err
}

type NullableNodePendingResult struct {
	value *NodePendingResult
	isSet bool
}

func (v NullableNodePendingResult) Get() *NodePendingResult {
	return v.value
}

func (v *NullableNodePendingResult) Set(val *NodePendingResult) {
	v.value = val
	v.isSet = true
}

func (v NullableNodePendingResult) IsSet() bool {
	return v.isSet
}

func (v *NullableNodePendingResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodePendingResult(val *NodePendingResult) *NullableNodePendingResult {
	return &NullableNodePendingResult{value: val, isSet: true}
}

func (v NullableNodePendingResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodePendingResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
