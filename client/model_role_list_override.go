...
// RoleListOverride the model 'RoleListOverride'
type RoleListOverride string

// List of role-list-override
const (
	OVERRIDE RoleListOverride = "override"
	NO_OVERRIDE RoleListOverride = "no-override"
	NONE RoleListOverride = "none"
)

// All allowed values of RoleListOverride enum
var AllowedRoleListOverrideEnumValues = []RoleListOverride{
	"override",
	"no-override",
	"none",
}

func (v *RoleListOverride) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := RoleListOverride(value)
	for _, existing := range AllowedRoleListOverrideEnumValues {
	...
	return fmt.Errorf("%+v is not a valid RoleListOverride", value)
}

// NewRoleListOverrideFromValue returns a pointer to a valid RoleListOverride
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewRoleListOverrideFromValue(v string) (*RoleListOverride, error) {
	ev := RoleListOverride(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for RoleListOverride: valid values are %v", v, AllowedRoleListOverrideEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v RoleListOverride) IsValid() bool {
	for _, existing := range AllowedRoleListOverrideEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to role-list-override value
func (v RoleListOverride) Ptr() *RoleListOverride {
	return &v
}

type NullableRoleListOverride struct {
	value *RoleListOverride
	isSet bool
}

func (v NullableRoleListOverride) Get() *RoleListOverride {
	return v.value
}

func (v *NullableRoleListOverride) Set(val *RoleListOverride) {
	v.value = val
	v.isSet = true
}

func (v NullableRoleListOverride) IsSet() bool {
	return v.isSet
}

func (v *NullableRoleListOverride) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoleListOverride(val *RoleListOverride) *NullableRoleListOverride {
	return &NullableRoleListOverride{value: val, isSet: true}
}

func (v NullableRoleListOverride) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoleListOverride) UnmarshalJSON(src []byte) error {
	v.isSet = true
