...
// checks if the GroupRuleCompliance type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupRuleCompliance{}

// GroupRuleCompliance struct for GroupRuleCompliance
type GroupRuleCompliance struct {
	// id of the rule
	Id string `json:"id"`
	// Name of the rule
	...
	Directives []GroupRuleComplianceDirectives `json:"directives"`
}

type _GroupRuleCompliance GroupRuleCompliance
...
func (o *GroupRuleCompliance) GetDirectives() []GroupRuleComplianceDirectives {
	if o == nil {
		var ret []GroupRuleComplianceDirectives
		return ret
	}
...
func (o GroupRuleCompliance) MarshalJSON() ([]byte, error) {
...
func (o GroupRuleCompliance) ToMap() (map[string]interface{}, error) {
...
func (o *GroupRuleCompliance) UnmarshalJSON(data []byte) (err error) {
	...
	varGroupRuleCompliance := _GroupRuleCompliance{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGroupRuleCompliance)

	if err != nil {
		return err
	}

	*o = GroupRuleCompliance(varGroupRuleCompliance)

	return err
}

type NullableGroupRuleCompliance struct {
	value *GroupRuleCompliance
	isSet bool
}

func (v NullableGroupRuleCompliance) Get() *GroupRuleCompliance {
	return v.value
}

func (v *NullableGroupRuleCompliance) Set(val *GroupRuleCompliance) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupRuleCompliance) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupRuleCompliance) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupRuleCompliance(val *GroupRuleCompliance) *NullableGroupRuleCompliance {
	return &NullableGroupRuleCompliance{value: val, isSet: true}
}

func (v NullableGroupRuleCompliance) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupRuleCompliance) UnmarshalJSON(src []byte) error {
	v.isSet = true
