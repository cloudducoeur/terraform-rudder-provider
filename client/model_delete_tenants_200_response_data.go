...
// checks if the DeleteTenants200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteTenants200ResponseData{}

// DeleteTenants200ResponseData struct for DeleteTenants200ResponseData
type DeleteTenants200ResponseData struct {
	Tenants []string `json:"tenants"`
}

type _DeleteTenants200ResponseData DeleteTenants200ResponseData
...
func NewDeleteTenants200ResponseData(tenants []string) *DeleteTenants200ResponseData {
	this := DeleteTenants200ResponseData{}
...
func (o DeleteTenants200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o DeleteTenants200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["tenants"] = o.Tenants
	return toSerialize, nil
}

func (o *DeleteTenants200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteTenants200ResponseData := _DeleteTenants200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteTenants200ResponseData)

	if err != nil {
		return err
	}

	*o = DeleteTenants200ResponseData(varDeleteTenants200ResponseData)

	return err
}

type NullableDeleteTenants200ResponseData struct {
	value *DeleteTenants200ResponseData
	isSet bool
}

func (v NullableDeleteTenants200ResponseData) Get() *DeleteTenants200ResponseData {
	return v.value
}

func (v *NullableDeleteTenants200ResponseData) Set(val *DeleteTenants200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteTenants200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteTenants200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteTenants200ResponseData(val *DeleteTenants200ResponseData) *NullableDeleteTenants200ResponseData {
	return &NullableDeleteTenants200ResponseData{value: val, isSet: true}
}

func (v NullableDeleteTenants200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteTenants200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
