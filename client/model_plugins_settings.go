...
// checks if the PluginsSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PluginsSettings{}

// PluginsSettings struct for PluginsSettings
...
type _PluginsSettings PluginsSettings
...
func (o PluginsSettings) MarshalJSON() ([]byte, error) {
...
func (o PluginsSettings) ToMap() (map[string]interface{}, error) {
...
func (o *PluginsSettings) UnmarshalJSON(data []byte) (err error) {
	...
	varPluginsSettings := _PluginsSettings{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPluginsSettings)

	if err != nil {
		return err
	}

	*o = PluginsSettings(varPluginsSettings)

	return err
}

type NullablePluginsSettings struct {
	value *PluginsSettings
	isSet bool
}

func (v NullablePluginsSettings) Get() *PluginsSettings {
	return v.value
}

func (v *NullablePluginsSettings) Set(val *PluginsSettings) {
	v.value = val
	v.isSet = true
}

func (v NullablePluginsSettings) IsSet() bool {
	return v.isSet
}

func (v *NullablePluginsSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePluginsSettings(val *PluginsSettings) *NullablePluginsSettings {
	return &NullablePluginsSettings{value: val, isSet: true}
}

func (v NullablePluginsSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePluginsSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
