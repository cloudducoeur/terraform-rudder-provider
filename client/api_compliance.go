...
type ApiGetNodeGroupComplianceIdRequest struct {
	ctx context.Context
	ApiService *ComplianceAPIService
	targetOrNodeGroupId GetNodeGroupComplianceIdTargetOrNodeGroupIdParameter
	level *int32
	precision *int32
}

// Number of depth level of compliance objects to display (1:rules, 2:directives, 3:components, 4:nodes, 5:values, 6:reports)
func (r ApiGetNodeGroupComplianceIdRequest) Level(level int32) ApiGetNodeGroupComplianceIdRequest {
	r.level = &level
	return r
}

// Number of digits after comma in compliance percent figures
func (r ApiGetNodeGroupComplianceIdRequest) Precision(precision int32) ApiGetNodeGroupComplianceIdRequest {
	r.precision = &precision
	return r
}

func (r ApiGetNodeGroupComplianceIdRequest) Execute() (*GetNodeGroupComplianceId200Response, *http.Response, error) {
	return r.ApiService.GetNodeGroupComplianceIdExecute(r)
}

/*
GetNodeGroupComplianceId Compliance details by group (global)

Get compliance of a group with all rules that apply to a node within the group.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param targetOrNodeGroupId Id of the node group or rule target
 @return ApiGetNodeGroupComplianceIdRequest
*/
func (a *ComplianceAPIService) GetNodeGroupComplianceId(ctx context.Context, targetOrNodeGroupId GetNodeGroupComplianceIdTargetOrNodeGroupIdParameter) ApiGetNodeGroupComplianceIdRequest {
	return ApiGetNodeGroupComplianceIdRequest{
		ApiService: a,
		ctx: ctx,
		targetOrNodeGroupId: targetOrNodeGroupId,
	}
}

// Execute executes the request
//  @return GetNodeGroupComplianceId200Response
func (a *ComplianceAPIService) GetNodeGroupComplianceIdExecute(r ApiGetNodeGroupComplianceIdRequest) (*GetNodeGroupComplianceId200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetNodeGroupComplianceId200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ComplianceAPIService.GetNodeGroupComplianceId")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/compliance/groups/{targetOrNodeGroupId}"
	localVarPath = strings.Replace(localVarPath, "{"+"targetOrNodeGroupId"+"}", url.PathEscape(parameterValueToString(r.targetOrNodeGroupId, "targetOrNodeGroupId")), -1)
...
type ApiGetNodeGroupComplianceTargetIdRequest struct {
	ctx context.Context
	ApiService *ComplianceAPIService
	targetOrNodeGroupId GetNodeGroupComplianceIdTargetOrNodeGroupIdParameter
	level *int32
...
// Number of depth level of compliance objects to display (1:rules, 2:directives, 3:components, 4:nodes, 5:values, 6:reports)
func (r ApiGetNodeGroupComplianceTargetIdRequest) Level(level int32) ApiGetNodeGroupComplianceTargetIdRequest {
	r.level = &level
	return r
}

// Number of digits after comma in compliance percent figures
func (r ApiGetNodeGroupComplianceTargetIdRequest) Precision(precision int32) ApiGetNodeGroupComplianceTargetIdRequest {
	r.precision = &precision
	return r
}

func (r ApiGetNodeGroupComplianceTargetIdRequest) Execute() (*GetNodeGroupComplianceTargetId200Response, *http.Response, error) {
	return r.ApiService.GetNodeGroupComplianceTargetIdExecute(r)
}

/*
GetNodeGroupComplianceTargetId Compliance details by group (targeted)

Get compliance of a group with only rules that explicitly include the group.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param targetOrNodeGroupId Id of the node group or rule target
 @return ApiGetNodeGroupComplianceTargetIdRequest
*/
func (a *ComplianceAPIService) GetNodeGroupComplianceTargetId(ctx context.Context, targetOrNodeGroupId GetNodeGroupComplianceIdTargetOrNodeGroupIdParameter) ApiGetNodeGroupComplianceTargetIdRequest {
	return ApiGetNodeGroupComplianceTargetIdRequest{
		ApiService: a,
		ctx: ctx,
		targetOrNodeGroupId: targetOrNodeGroupId,
...
// Execute executes the request
//  @return GetNodeGroupComplianceTargetId200Response
func (a *ComplianceAPIService) GetNodeGroupComplianceTargetIdExecute(r ApiGetNodeGroupComplianceTargetIdRequest) (*GetNodeGroupComplianceTargetId200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetNodeGroupComplianceTargetId200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ComplianceAPIService.GetNodeGroupComplianceTargetId")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/compliance/groups/{targetOrNodeGroupId}/target"
	localVarPath = strings.Replace(localVarPath, "{"+"targetOrNodeGroupId"+"}", url.PathEscape(parameterValueToString(r.targetOrNodeGroupId, "targetOrNodeGroupId")), -1)
