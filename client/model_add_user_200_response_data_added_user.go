...
type AddUser200ResponseDataAddedUser struct {
	...
	// New given password, hashed or not
	Password string `json:"password"`
	// Permissions of new user
...
type _AddUser200ResponseDataAddedUser AddUser200ResponseDataAddedUser
...
func (o *AddUser200ResponseDataAddedUser) UnmarshalJSON(data []byte) (err error) {
	...
	varAddUser200ResponseDataAddedUser := _AddUser200ResponseDataAddedUser{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAddUser200ResponseDataAddedUser)

	if err != nil {
		return err
	}

	*o = AddUser200ResponseDataAddedUser(varAddUser200ResponseDataAddedUser)
