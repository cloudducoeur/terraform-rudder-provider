...
type NodeAddInner struct {
	...
	Machine *NodeAddInnerMachine `json:"machine,omitempty"`
...
// SetMachine gets a reference to the given NodeAddInnerMachine and assigns it to the Machine field.
