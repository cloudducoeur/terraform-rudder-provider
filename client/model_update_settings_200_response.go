...
// checks if the UpdateSettings200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateSettings200Response{}

// UpdateSettings200Response struct for UpdateSettings200Response
type UpdateSettings200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data UpdateSettings200ResponseData `json:"data"`
}

type _UpdateSettings200Response UpdateSettings200Response
...
func NewUpdateSettings200Response(result string, action string, data UpdateSettings200ResponseData) *UpdateSettings200Response {
	this := UpdateSettings200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *UpdateSettings200Response) GetData() UpdateSettings200ResponseData {
	if o == nil {
		var ret UpdateSettings200ResponseData
		return ret
	}
...
func (o UpdateSettings200Response) MarshalJSON() ([]byte, error) {
...
func (o UpdateSettings200Response) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateSettings200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateSettings200Response := _UpdateSettings200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateSettings200Response)

	if err != nil {
		return err
	}

	*o = UpdateSettings200Response(varUpdateSettings200Response)

	return err
}

type NullableUpdateSettings200Response struct {
	value *UpdateSettings200Response
	isSet bool
}

func (v NullableUpdateSettings200Response) Get() *UpdateSettings200Response {
	return v.value
}

func (v *NullableUpdateSettings200Response) Set(val *UpdateSettings200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateSettings200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateSettings200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateSettings200Response(val *UpdateSettings200Response) *NullableUpdateSettings200Response {
	return &NullableUpdateSettings200Response{value: val, isSet: true}
}

func (v NullableUpdateSettings200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateSettings200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
