...
// Optional merge algo of the import. Default &#x60;override-all&#x60; means what is in the archive is the new reality.  &#x60;keep-rule-targets&#x60; will keep existing target definition for existing rules (ignore archive value). &#x60;ignore-source-targets&#x60; is like &#x60;keep-rule-targets&#x60; but in addition sets an empty target for new rules.
...
// IDs (optionally with revision, &#39;+&#39; need to be escaped as &#39;%2B&#39;) of rules to include.  The special key-word &#39;all&#39; can be use to mean \&quot;all non-system rules\&quot;
func (r ApiExportRequest) Rules(rules []string) ApiExportRequest {
	r.rules = &rules
	return r
}

// IDs (optionally with revision, &#39;+&#39; need to be escaped as &#39;%2B&#39;) of directives to include The special key-word &#39;all&#39; can be use to mean \&quot;all non-system directives\&quot;
func (r ApiExportRequest) Directives(directives []string) ApiExportRequest {
	r.directives = &directives
	return r
}

// IDs, ie technique name/technique version (optionally with revision, &#39;+&#39; need to be escaped as &#39;%2B&#39;) of techniques to include The special key-word &#39;all&#39; can be use to mean \&quot;all non-system techniques\&quot;
func (r ApiExportRequest) Techniques(techniques []string) ApiExportRequest {
	r.techniques = &techniques
	return r
}

// IDs (optionally with revision, &#39;+&#39; need to be escaped as &#39;%2B&#39;) of groups to include The special key-word &#39;all&#39; can be use to mean \&quot;all non-system groups\&quot;
...
func (a *ArchivesAPIService) ExportExecute(r ApiExportRequest) (*os.File, *http.Response, error) {
	...
	if r.rules != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "rules", r.rules, "form", "csv")
	}
	if r.directives != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "directives", r.directives, "form", "csv")
	}
	if r.techniques != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "techniques", r.techniques, "form", "csv")
	}
	if r.groups != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "groups", r.groups, "form", "csv")
	}
	if r.include != nil {
