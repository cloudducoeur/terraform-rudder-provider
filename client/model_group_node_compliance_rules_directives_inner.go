...
// checks if the GroupNodeComplianceRulesDirectivesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupNodeComplianceRulesDirectivesInner{}

// GroupNodeComplianceRulesDirectivesInner struct for GroupNodeComplianceRulesDirectivesInner
type GroupNodeComplianceRulesDirectivesInner struct {
	// id of the directive
	Id string `json:"id"`
	...
	Components []GroupNodeComplianceRulesDirectivesInnerComponentsInner `json:"components"`
}

type _GroupNodeComplianceRulesDirectivesInner GroupNodeComplianceRulesDirectivesInner
...
func NewGroupNodeComplianceRulesDirectivesInner(id string, name string, compliance float32, complianceDetails RuleComplianceComponentComplianceDetails, components []GroupNodeComplianceRulesDirectivesInnerComponentsInner) *GroupNodeComplianceRulesDirectivesInner {
	this := GroupNodeComplianceRulesDirectivesInner{}
	this.Id = id
	this.Name = name
...
func (o *GroupNodeComplianceRulesDirectivesInner) GetComponents() []GroupNodeComplianceRulesDirectivesInnerComponentsInner {
	if o == nil {
		var ret []GroupNodeComplianceRulesDirectivesInnerComponentsInner
		return ret
	}
...
func (o GroupNodeComplianceRulesDirectivesInner) MarshalJSON() ([]byte, error) {
...
func (o GroupNodeComplianceRulesDirectivesInner) ToMap() (map[string]interface{}, error) {
...
func (o *GroupNodeComplianceRulesDirectivesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varGroupNodeComplianceRulesDirectivesInner := _GroupNodeComplianceRulesDirectivesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGroupNodeComplianceRulesDirectivesInner)

	if err != nil {
		return err
	}

	*o = GroupNodeComplianceRulesDirectivesInner(varGroupNodeComplianceRulesDirectivesInner)

	return err
}

type NullableGroupNodeComplianceRulesDirectivesInner struct {
	value *GroupNodeComplianceRulesDirectivesInner
	isSet bool
}

func (v NullableGroupNodeComplianceRulesDirectivesInner) Get() *GroupNodeComplianceRulesDirectivesInner {
	return v.value
}

func (v *NullableGroupNodeComplianceRulesDirectivesInner) Set(val *GroupNodeComplianceRulesDirectivesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupNodeComplianceRulesDirectivesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupNodeComplianceRulesDirectivesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupNodeComplianceRulesDirectivesInner(val *GroupNodeComplianceRulesDirectivesInner) *NullableGroupNodeComplianceRulesDirectivesInner {
	return &NullableGroupNodeComplianceRulesDirectivesInner{value: val, isSet: true}
}

func (v NullableGroupNodeComplianceRulesDirectivesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupNodeComplianceRulesDirectivesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
