...
// List of rule-target
const (
	SPECIAL_ALL RuleTarget = "special:all"
	SPECIAL_ALL_EXCEPT_POLICY_SERVERS RuleTarget = "special:all_exceptPolicyServers"
	SPECIAL_ALL_POLICY_SERVERS RuleTarget = "special:all_policyServers"
	POLICY_SERVER___POLICY_SERVER_ID RuleTarget = "policyServer:${policyServerId}"
	GROUP___NODE_GROUP_ID RuleTarget = "group:${nodeGroupId}"
)
