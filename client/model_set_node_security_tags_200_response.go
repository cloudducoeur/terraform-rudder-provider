...
// checks if the SetNodeSecurityTags200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SetNodeSecurityTags200Response{}

// SetNodeSecurityTags200Response struct for SetNodeSecurityTags200Response
type SetNodeSecurityTags200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data SetNodeSecurityTags200ResponseData `json:"data"`
}

type _SetNodeSecurityTags200Response SetNodeSecurityTags200Response
...
func NewSetNodeSecurityTags200Response(result string, action string, data SetNodeSecurityTags200ResponseData) *SetNodeSecurityTags200Response {
	this := SetNodeSecurityTags200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *SetNodeSecurityTags200Response) GetData() SetNodeSecurityTags200ResponseData {
	if o == nil {
		var ret SetNodeSecurityTags200ResponseData
		return ret
	}
...
func (o SetNodeSecurityTags200Response) MarshalJSON() ([]byte, error) {
...
func (o SetNodeSecurityTags200Response) ToMap() (map[string]interface{}, error) {
...
func (o *SetNodeSecurityTags200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varSetNodeSecurityTags200Response := _SetNodeSecurityTags200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSetNodeSecurityTags200Response)

	if err != nil {
		return err
	}

	*o = SetNodeSecurityTags200Response(varSetNodeSecurityTags200Response)

	return err
}

type NullableSetNodeSecurityTags200Response struct {
	value *SetNodeSecurityTags200Response
	isSet bool
}

func (v NullableSetNodeSecurityTags200Response) Get() *SetNodeSecurityTags200Response {
	return v.value
}

func (v *NullableSetNodeSecurityTags200Response) Set(val *SetNodeSecurityTags200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableSetNodeSecurityTags200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableSetNodeSecurityTags200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSetNodeSecurityTags200Response(val *SetNodeSecurityTags200Response) *NullableSetNodeSecurityTags200Response {
	return &NullableSetNodeSecurityTags200Response{value: val, isSet: true}
}

func (v NullableSetNodeSecurityTags200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSetNodeSecurityTags200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
