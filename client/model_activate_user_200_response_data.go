...
// checks if the ActivateUser200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActivateUser200ResponseData{}

// ActivateUser200ResponseData struct for ActivateUser200ResponseData
type ActivateUser200ResponseData struct {
	Status UserStatus `json:"status"`
}

type _ActivateUser200ResponseData ActivateUser200ResponseData
...
func NewActivateUser200ResponseData(status UserStatus) *ActivateUser200ResponseData {
	this := ActivateUser200ResponseData{}
	this.Status = status
	return &this
}
...
func (o ActivateUser200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o ActivateUser200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["status"] = o.Status
	return toSerialize, nil
}

func (o *ActivateUser200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varActivateUser200ResponseData := _ActivateUser200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varActivateUser200ResponseData)

	if err != nil {
		return err
	}

	*o = ActivateUser200ResponseData(varActivateUser200ResponseData)

	return err
}

type NullableActivateUser200ResponseData struct {
	value *ActivateUser200ResponseData
	isSet bool
}

func (v NullableActivateUser200ResponseData) Get() *ActivateUser200ResponseData {
	return v.value
}

func (v *NullableActivateUser200ResponseData) Set(val *ActivateUser200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableActivateUser200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableActivateUser200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActivateUser200ResponseData(val *ActivateUser200ResponseData) *NullableActivateUser200ResponseData {
	return &NullableActivateUser200ResponseData{value: val, isSet: true}
}

func (v NullableActivateUser200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActivateUser200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
