...
// checks if the GetNodeGroupComplianceTargetId200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNodeGroupComplianceTargetId200Response{}

// GetNodeGroupComplianceTargetId200Response struct for GetNodeGroupComplianceTargetId200Response
type GetNodeGroupComplianceTargetId200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data GetNodeGroupComplianceId200ResponseData `json:"data"`
}

type _GetNodeGroupComplianceTargetId200Response GetNodeGroupComplianceTargetId200Response
...
func NewGetNodeGroupComplianceTargetId200Response(result string, action string, data GetNodeGroupComplianceId200ResponseData) *GetNodeGroupComplianceTargetId200Response {
	this := GetNodeGroupComplianceTargetId200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *GetNodeGroupComplianceTargetId200Response) GetData() GetNodeGroupComplianceId200ResponseData {
	if o == nil {
		var ret GetNodeGroupComplianceId200ResponseData
		return ret
	}
...
func (o GetNodeGroupComplianceTargetId200Response) MarshalJSON() ([]byte, error) {
...
func (o GetNodeGroupComplianceTargetId200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetNodeGroupComplianceTargetId200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetNodeGroupComplianceTargetId200Response := _GetNodeGroupComplianceTargetId200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetNodeGroupComplianceTargetId200Response)

	if err != nil {
		return err
	}

	*o = GetNodeGroupComplianceTargetId200Response(varGetNodeGroupComplianceTargetId200Response)

	return err
}

type NullableGetNodeGroupComplianceTargetId200Response struct {
	value *GetNodeGroupComplianceTargetId200Response
	isSet bool
}

func (v NullableGetNodeGroupComplianceTargetId200Response) Get() *GetNodeGroupComplianceTargetId200Response {
	return v.value
}

func (v *NullableGetNodeGroupComplianceTargetId200Response) Set(val *GetNodeGroupComplianceTargetId200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNodeGroupComplianceTargetId200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNodeGroupComplianceTargetId200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNodeGroupComplianceTargetId200Response(val *GetNodeGroupComplianceTargetId200Response) *NullableGetNodeGroupComplianceTargetId200Response {
	return &NullableGetNodeGroupComplianceTargetId200Response{value: val, isSet: true}
}

func (v NullableGetNodeGroupComplianceTargetId200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNodeGroupComplianceTargetId200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
