...
// checks if the ApiAccountAclInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiAccountAclInner{}

// ApiAccountAclInner struct for ApiAccountAclInner
type ApiAccountAclInner struct {
...
func (o ApiAccountAclInner) MarshalJSON() ([]byte, error) {
...
func (o ApiAccountAclInner) ToMap() (map[string]interface{}, error) {
...
type NullableApiAccountAclInner struct {
	value *ApiAccountAclInner
	isSet bool
}

func (v NullableApiAccountAclInner) Get() *ApiAccountAclInner {
	return v.value
}

func (v *NullableApiAccountAclInner) Set(val *ApiAccountAclInner) {
	v.value = val
	v.isSet = true
}

func (v NullableApiAccountAclInner) IsSet() bool {
	return v.isSet
}

func (v *NullableApiAccountAclInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiAccountAclInner(val *ApiAccountAclInner) *NullableApiAccountAclInner {
	return &NullableApiAccountAclInner{value: val, isSet: true}
}

func (v NullableApiAccountAclInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiAccountAclInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
