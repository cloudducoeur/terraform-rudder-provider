...
// checks if the CampaignScheduleDaily type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignScheduleDaily{}

// CampaignScheduleDaily struct for CampaignScheduleDaily
type CampaignScheduleDaily struct {
	Start *CampaignScheduleDailyStart `json:"start,omitempty"`
	End *CampaignScheduleDailyEnd `json:"end,omitempty"`
	// IANA timezone ID associated with the start and end times of the campaign schedule
...
func (o *CampaignScheduleDaily) GetStart() CampaignScheduleDailyStart {
	if o == nil || IsNil(o.Start) {
		var ret CampaignScheduleDailyStart
		return ret
	}
	return *o.Start
}
...
// SetStart gets a reference to the given CampaignScheduleDailyStart and assigns it to the Start field.
...
func (o *CampaignScheduleDaily) GetEnd() CampaignScheduleDailyEnd {
	if o == nil || IsNil(o.End) {
		var ret CampaignScheduleDailyEnd
		return ret
	}
	return *o.End
}
...
// SetEnd gets a reference to the given CampaignScheduleDailyEnd and assigns it to the End field.
...
func (o CampaignScheduleDaily) MarshalJSON() ([]byte, error) {
...
func (o CampaignScheduleDaily) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignScheduleDaily struct {
	value *CampaignScheduleDaily
	isSet bool
}

func (v NullableCampaignScheduleDaily) Get() *CampaignScheduleDaily {
	return v.value
}

func (v *NullableCampaignScheduleDaily) Set(val *CampaignScheduleDaily) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignScheduleDaily) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignScheduleDaily) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignScheduleDaily(val *CampaignScheduleDaily) *NullableCampaignScheduleDaily {
	return &NullableCampaignScheduleDaily{value: val, isSet: true}
}

func (v NullableCampaignScheduleDaily) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignScheduleDaily) UnmarshalJSON(src []byte) error {
	v.isSet = true
