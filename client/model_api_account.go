...
// checks if the ApiAccount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiAccount{}

// ApiAccount struct for ApiAccount
type ApiAccount struct {
	...
	// Creation date of the API account
	CreationDate *string `json:"creationDate,omitempty"`
	// Expiration policy of the API account (not the token)
	ExpirationPolicy *string `json:"expirationPolicy,omitempty"`
	// Optional expiration date of the API account
	ExpirationDate *string `json:"expirationDate,omitempty"`
	// State of the token for that account. An account with token state 'missing' means that there is no token for that account.
	TokenState *string `json:"tokenState,omitempty"`
	// The token secret. It will be returned only once when a new token is generated.
	Token *string `json:"token,omitempty"`
	// Optional generation date for the token when tokenState is 'generated'
	TokenGenerationDate *string `json:"tokenGenerationDate,omitempty"`
	// a comma separated list of tenants allowed for that account. See tenant documentation for syntax.
	...
	// in case of ACL authorization type, the actual ACL
	Acl []ApiAccountAclInner `json:"acl,omitempty"`
}
...
// GetTokenGenerationDate returns the TokenGenerationDate field value if set, zero value otherwise.
func (o *ApiAccount) GetTokenGenerationDate() string {
	if o == nil || IsNil(o.TokenGenerationDate) {
		var ret string
		return ret
	}
	return *o.TokenGenerationDate
}

// GetTokenGenerationDateOk returns a tuple with the TokenGenerationDate field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ApiAccount) GetTokenGenerationDateOk() (*string, bool) {
	if o == nil || IsNil(o.TokenGenerationDate) {
		return nil, false
	}
	return o.TokenGenerationDate, true
}
...
// SetTokenGenerationDate gets a reference to the given string and assigns it to the TokenGenerationDate field.
func (o *ApiAccount) SetTokenGenerationDate(v string) {
	o.TokenGenerationDate = &v
}
...
// SetAcl gets a reference to the given []ApiAccountAclInner and assigns it to the Acl field.
func (o *ApiAccount) SetAcl(v []ApiAccountAclInner) {
	o.Acl = v
}

func (o ApiAccount) MarshalJSON() ([]byte, error) {
...
func (o ApiAccount) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TokenState) {
		toSerialize["tokenState"] = o.TokenState
	}
	if !IsNil(o.Token) {
		toSerialize["token"] = o.Token
	}
	if !IsNil(o.TokenGenerationDate) {
		toSerialize["tokenGenerationDate"] = o.TokenGenerationDate
	}
	if !IsNil(o.Tenants) {
...
type NullableApiAccount struct {
	value *ApiAccount
	isSet bool
}

func (v NullableApiAccount) Get() *ApiAccount {
	return v.value
}

func (v *NullableApiAccount) Set(val *ApiAccount) {
	v.value = val
	v.isSet = true
}

func (v NullableApiAccount) IsSet() bool {
	return v.isSet
}

func (v *NullableApiAccount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiAccount(val *ApiAccount) *NullableApiAccount {
	return &NullableApiAccount{value: val, isSet: true}
}

func (v NullableApiAccount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiAccount) UnmarshalJSON(src []byte) error {
	v.isSet = true
