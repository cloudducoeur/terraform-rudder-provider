...
// checks if the GetNodeGroupComplianceId200ResponseDataNodeGroupsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNodeGroupComplianceId200ResponseDataNodeGroupsInner{}

// GetNodeGroupComplianceId200ResponseDataNodeGroupsInner struct for GetNodeGroupComplianceId200ResponseDataNodeGroupsInner
type GetNodeGroupComplianceId200ResponseDataNodeGroupsInner struct {
	// id of the group
	Id string `json:"id"`
	Mode string `json:"mode"`
	// Group compliance level
	...
	Rules []GroupRuleCompliance `json:"rules"`
	Nodes []GroupNodeCompliance `json:"nodes"`
}

type _GetNodeGroupComplianceId200ResponseDataNodeGroupsInner GetNodeGroupComplianceId200ResponseDataNodeGroupsInner
...
func NewGetNodeGroupComplianceId200ResponseDataNodeGroupsInner(id string, mode string, compliance float32, complianceDetails GetGlobalCompliance200ResponseDataGlobalComplianceComplianceDetails, rules []GroupRuleCompliance, nodes []GroupNodeCompliance) *GetNodeGroupComplianceId200ResponseDataNodeGroupsInner {
	this := GetNodeGroupComplianceId200ResponseDataNodeGroupsInner{}
	this.Id = id
	this.Mode = mode
...
func (o GetNodeGroupComplianceId200ResponseDataNodeGroupsInner) MarshalJSON() ([]byte, error) {
...
func (o GetNodeGroupComplianceId200ResponseDataNodeGroupsInner) ToMap() (map[string]interface{}, error) {
...
func (o *GetNodeGroupComplianceId200ResponseDataNodeGroupsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varGetNodeGroupComplianceId200ResponseDataNodeGroupsInner := _GetNodeGroupComplianceId200ResponseDataNodeGroupsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetNodeGroupComplianceId200ResponseDataNodeGroupsInner)

	if err != nil {
		return err
	}

	*o = GetNodeGroupComplianceId200ResponseDataNodeGroupsInner(varGetNodeGroupComplianceId200ResponseDataNodeGroupsInner)

	return err
}

type NullableGetNodeGroupComplianceId200ResponseDataNodeGroupsInner struct {
	value *GetNodeGroupComplianceId200ResponseDataNodeGroupsInner
	isSet bool
}

func (v NullableGetNodeGroupComplianceId200ResponseDataNodeGroupsInner) Get() *GetNodeGroupComplianceId200ResponseDataNodeGroupsInner {
	return v.value
}

func (v *NullableGetNodeGroupComplianceId200ResponseDataNodeGroupsInner) Set(val *GetNodeGroupComplianceId200ResponseDataNodeGroupsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNodeGroupComplianceId200ResponseDataNodeGroupsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNodeGroupComplianceId200ResponseDataNodeGroupsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNodeGroupComplianceId200ResponseDataNodeGroupsInner(val *GetNodeGroupComplianceId200ResponseDataNodeGroupsInner) *NullableGetNodeGroupComplianceId200ResponseDataNodeGroupsInner {
	return &NullableGetNodeGroupComplianceId200ResponseDataNodeGroupsInner{value: val, isSet: true}
}

func (v NullableGetNodeGroupComplianceId200ResponseDataNodeGroupsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNodeGroupComplianceId200ResponseDataNodeGroupsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
