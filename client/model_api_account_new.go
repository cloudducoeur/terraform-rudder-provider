...
// checks if the ApiAccountNew type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiAccountNew{}

// ApiAccountNew struct for ApiAccountNew
type ApiAccountNew struct {
...
func (o ApiAccountNew) MarshalJSON() ([]byte, error) {
...
func (o ApiAccountNew) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.GenerateToken) {
		toSerialize["generateToken"] = o.GenerateToken
	}
...
type NullableApiAccountNew struct {
	value *ApiAccountNew
	isSet bool
}

func (v NullableApiAccountNew) Get() *ApiAccountNew {
	return v.value
}

func (v *NullableApiAccountNew) Set(val *ApiAccountNew) {
	v.value = val
	v.isSet = true
}

func (v NullableApiAccountNew) IsSet() bool {
	return v.isSet
}

func (v *NullableApiAccountNew) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiAccountNew(val *ApiAccountNew) *NullableApiAccountNew {
	return &NullableApiAccountNew{value: val, isSet: true}
}

func (v NullableApiAccountNew) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiAccountNew) UnmarshalJSON(src []byte) error {
	v.isSet = true
