...
// checks if the GroupNodeComplianceRulesDirectivesInnerComponentsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupNodeComplianceRulesDirectivesInnerComponentsInner{}

// GroupNodeComplianceRulesDirectivesInnerComponentsInner struct for GroupNodeComplianceRulesDirectivesInnerComponentsInner
type GroupNodeComplianceRulesDirectivesInnerComponentsInner struct {
	...
	Values []GroupNodeComplianceRulesDirectivesInnerComponentsInnerValuesInner `json:"values"`
}

type _GroupNodeComplianceRulesDirectivesInnerComponentsInner GroupNodeComplianceRulesDirectivesInnerComponentsInner
...
func NewGroupNodeComplianceRulesDirectivesInnerComponentsInner(name string, compliance float32, complianceDetails NodeComplianceComponentComplianceDetails, values []GroupNodeComplianceRulesDirectivesInnerComponentsInnerValuesInner) *GroupNodeComplianceRulesDirectivesInnerComponentsInner {
	this := GroupNodeComplianceRulesDirectivesInnerComponentsInner{}
	this.Name = name
...
func (o *GroupNodeComplianceRulesDirectivesInnerComponentsInner) GetValues() []GroupNodeComplianceRulesDirectivesInnerComponentsInnerValuesInner {
	if o == nil {
		var ret []GroupNodeComplianceRulesDirectivesInnerComponentsInnerValuesInner
		return ret
	}
...
func (o GroupNodeComplianceRulesDirectivesInnerComponentsInner) MarshalJSON() ([]byte, error) {
...
func (o GroupNodeComplianceRulesDirectivesInnerComponentsInner) ToMap() (map[string]interface{}, error) {
...
func (o *GroupNodeComplianceRulesDirectivesInnerComponentsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varGroupNodeComplianceRulesDirectivesInnerComponentsInner := _GroupNodeComplianceRulesDirectivesInnerComponentsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGroupNodeComplianceRulesDirectivesInnerComponentsInner)

	if err != nil {
		return err
	}

	*o = GroupNodeComplianceRulesDirectivesInnerComponentsInner(varGroupNodeComplianceRulesDirectivesInnerComponentsInner)

	return err
}

type NullableGroupNodeComplianceRulesDirectivesInnerComponentsInner struct {
	value *GroupNodeComplianceRulesDirectivesInnerComponentsInner
	isSet bool
}

func (v NullableGroupNodeComplianceRulesDirectivesInnerComponentsInner) Get() *GroupNodeComplianceRulesDirectivesInnerComponentsInner {
	return v.value
}

func (v *NullableGroupNodeComplianceRulesDirectivesInnerComponentsInner) Set(val *GroupNodeComplianceRulesDirectivesInnerComponentsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupNodeComplianceRulesDirectivesInnerComponentsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupNodeComplianceRulesDirectivesInnerComponentsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupNodeComplianceRulesDirectivesInnerComponentsInner(val *GroupNodeComplianceRulesDirectivesInnerComponentsInner) *NullableGroupNodeComplianceRulesDirectivesInnerComponentsInner {
	return &NullableGroupNodeComplianceRulesDirectivesInnerComponentsInner{value: val, isSet: true}
}

func (v NullableGroupNodeComplianceRulesDirectivesInnerComponentsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupNodeComplianceRulesDirectivesInnerComponentsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
