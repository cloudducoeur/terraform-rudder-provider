...
// checks if the GetAllAccounts200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAllAccounts200ResponseData{}

// GetAllAccounts200ResponseData struct for GetAllAccounts200ResponseData
type GetAllAccounts200ResponseData struct {
	Accounts []ApiAccount `json:"accounts"`
}

type _GetAllAccounts200ResponseData GetAllAccounts200ResponseData
...
func NewGetAllAccounts200ResponseData(accounts []ApiAccount) *GetAllAccounts200ResponseData {
	this := GetAllAccounts200ResponseData{}
...
func (o GetAllAccounts200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetAllAccounts200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["accounts"] = o.Accounts
	return toSerialize, nil
}

func (o *GetAllAccounts200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varGetAllAccounts200ResponseData := _GetAllAccounts200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetAllAccounts200ResponseData)

	if err != nil {
		return err
	}

	*o = GetAllAccounts200ResponseData(varGetAllAccounts200ResponseData)

	return err
}

type NullableGetAllAccounts200ResponseData struct {
	value *GetAllAccounts200ResponseData
	isSet bool
}

func (v NullableGetAllAccounts200ResponseData) Get() *GetAllAccounts200ResponseData {
	return v.value
}

func (v *NullableGetAllAccounts200ResponseData) Set(val *GetAllAccounts200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAllAccounts200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAllAccounts200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAllAccounts200ResponseData(val *GetAllAccounts200ResponseData) *NullableGetAllAccounts200ResponseData {
	return &NullableGetAllAccounts200ResponseData{value: val, isSet: true}
}

func (v NullableGetAllAccounts200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAllAccounts200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
