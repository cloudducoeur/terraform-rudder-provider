...
// checks if the GroupNodeComplianceRules type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupNodeComplianceRules{}

// GroupNodeComplianceRules struct for GroupNodeComplianceRules
type GroupNodeComplianceRules struct {
	// id of the rule
	Id string `json:"id"`
	// Name of the rule
	...
	Directives []GroupNodeComplianceRulesDirectivesInner `json:"directives"`
}

type _GroupNodeComplianceRules GroupNodeComplianceRules
...
func (o *GroupNodeComplianceRules) GetDirectives() []GroupNodeComplianceRulesDirectivesInner {
	if o == nil {
		var ret []GroupNodeComplianceRulesDirectivesInner
		return ret
	}
...
func (o GroupNodeComplianceRules) MarshalJSON() ([]byte, error) {
...
func (o GroupNodeComplianceRules) ToMap() (map[string]interface{}, error) {
...
func (o *GroupNodeComplianceRules) UnmarshalJSON(data []byte) (err error) {
	...
	varGroupNodeComplianceRules := _GroupNodeComplianceRules{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGroupNodeComplianceRules)

	if err != nil {
		return err
	}

	*o = GroupNodeComplianceRules(varGroupNodeComplianceRules)

	return err
}

type NullableGroupNodeComplianceRules struct {
	value *GroupNodeComplianceRules
	isSet bool
}

func (v NullableGroupNodeComplianceRules) Get() *GroupNodeComplianceRules {
	return v.value
}

func (v *NullableGroupNodeComplianceRules) Set(val *GroupNodeComplianceRules) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupNodeComplianceRules) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupNodeComplianceRules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupNodeComplianceRules(val *GroupNodeComplianceRules) *NullableGroupNodeComplianceRules {
	return &NullableGroupNodeComplianceRules{value: val, isSet: true}
}

func (v NullableGroupNodeComplianceRules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupNodeComplianceRules) UnmarshalJSON(src []byte) error {
	v.isSet = true
