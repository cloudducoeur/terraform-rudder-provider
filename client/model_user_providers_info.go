...
// checks if the UserProvidersInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserProvidersInfo{}

// UserProvidersInfo struct for UserProvidersInfo
type UserProvidersInfo struct {
	Provider *string `json:"provider,omitempty"`
	Authz []string `json:"authz,omitempty"`
	Roles []string `json:"roles,omitempty"`
	CustomRights []string `json:"customRights,omitempty"`
}
...
// GetCustomRights returns the CustomRights field value if set, zero value otherwise.
func (o *UserProvidersInfo) GetCustomRights() []string {
	if o == nil || IsNil(o.CustomRights) {
		var ret []string
		return ret
	}
	return o.CustomRights
}

// GetCustomRightsOk returns a tuple with the CustomRights field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UserProvidersInfo) GetCustomRightsOk() ([]string, bool) {
	if o == nil || IsNil(o.CustomRights) {
		return nil, false
	}
	return o.CustomRights, true
}
...
// SetCustomRights gets a reference to the given []string and assigns it to the CustomRights field.
func (o *UserProvidersInfo) SetCustomRights(v []string) {
	o.CustomRights = v
}

func (o UserProvidersInfo) MarshalJSON() ([]byte, error) {
...
func (o UserProvidersInfo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CustomRights) {
		toSerialize["customRights"] = o.CustomRights
	}
	return toSerialize, nil
}

type NullableUserProvidersInfo struct {
	value *UserProvidersInfo
	isSet bool
}

func (v NullableUserProvidersInfo) Get() *UserProvidersInfo {
	return v.value
}

func (v *NullableUserProvidersInfo) Set(val *UserProvidersInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableUserProvidersInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableUserProvidersInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserProvidersInfo(val *UserProvidersInfo) *NullableUserProvidersInfo {
	return &NullableUserProvidersInfo{value: val, isSet: true}
}

func (v NullableUserProvidersInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserProvidersInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
