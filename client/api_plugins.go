...
type ApiGetPluginsInfoRequest struct {
	ctx context.Context
	ApiService *PluginsAPIService
}

func (r ApiGetPluginsInfoRequest) Execute() (*GetPluginsInfo200Response, *http.Response, error) {
	return r.ApiService.GetPluginsInfoExecute(r)
}

/*
GetPluginsInfo Information about installed plugins

Get the list of plugin details and their licenses information

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetPluginsInfoRequest
*/
func (a *PluginsAPIService) GetPluginsInfo(ctx context.Context) ApiGetPluginsInfoRequest {
	return ApiGetPluginsInfoRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return GetPluginsInfo200Response
func (a *PluginsAPIService) GetPluginsInfoExecute(r ApiGetPluginsInfoRequest) (*GetPluginsInfo200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetPluginsInfo200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PluginsAPIService.GetPluginsInfo")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/plugins/info"
...
type ApiPluginSettingsRequest struct {
	ctx context.Context
	ApiService *PluginsAPIService
}

func (r ApiPluginSettingsRequest) Execute() (*PluginSettings200Response, *http.Response, error) {
	return r.ApiService.PluginSettingsExecute(r)
}
...
Get plugins url and proxy settings
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiPluginSettingsRequest
*/
func (a *PluginsAPIService) PluginSettings(ctx context.Context) ApiPluginSettingsRequest {
	return ApiPluginSettingsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return PluginSettings200Response
func (a *PluginsAPIService) PluginSettingsExecute(r ApiPluginSettingsRequest) (*PluginSettings200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PluginSettings200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PluginsAPIService.PluginSettings")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/plugins/settings"
...
func (r ApiUpdateSettingsRequest) Execute() (*UpdateSettings200Response, *http.Response, error) {
...
*/
func (a *PluginsAPIService) UpdateSettings(ctx context.Context) ApiUpdateSettingsRequest {
	return ApiUpdateSettingsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return UpdateSettings200Response
func (a *PluginsAPIService) UpdateSettingsExecute(r ApiUpdateSettingsRequest) (*UpdateSettings200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *UpdateSettings200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PluginsAPIService.UpdateSettings")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
