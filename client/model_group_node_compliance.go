...
// checks if the GroupNodeCompliance type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupNodeCompliance{}

// GroupNodeCompliance struct for GroupNodeCompliance
type GroupNodeCompliance struct {
	// id of the node
	Id string `json:"id"`
	// Name of the node
	Name string `json:"name"`
	// Policy mode of the node
	PolicyMode string `json:"policyMode"`
	// Node compliance level
	Compliance float32 `json:"compliance"`
	ComplianceDetails NodeComplianceComponentComplianceDetails `json:"complianceDetails"`
	Rules []GroupNodeComplianceRules `json:"rules"`
}

type _GroupNodeCompliance GroupNodeCompliance
...
func (o *GroupNodeCompliance) GetRules() []GroupNodeComplianceRules {
	if o == nil {
		var ret []GroupNodeComplianceRules
		return ret
	}
...
func (o GroupNodeCompliance) MarshalJSON() ([]byte, error) {
...
func (o GroupNodeCompliance) ToMap() (map[string]interface{}, error) {
...
func (o *GroupNodeCompliance) UnmarshalJSON(data []byte) (err error) {
	...
	varGroupNodeCompliance := _GroupNodeCompliance{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGroupNodeCompliance)

	if err != nil {
		return err
	}

	*o = GroupNodeCompliance(varGroupNodeCompliance)

	return err
}

type NullableGroupNodeCompliance struct {
	value *GroupNodeCompliance
	isSet bool
}

func (v NullableGroupNodeCompliance) Get() *GroupNodeCompliance {
	return v.value
}

func (v *NullableGroupNodeCompliance) Set(val *GroupNodeCompliance) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupNodeCompliance) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupNodeCompliance) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupNodeCompliance(val *GroupNodeCompliance) *NullableGroupNodeCompliance {
	return &NullableGroupNodeCompliance{value: val, isSet: true}
}

func (v NullableGroupNodeCompliance) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupNodeCompliance) UnmarshalJSON(src []byte) error {
	v.isSet = true
