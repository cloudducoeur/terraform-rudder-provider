...
// checks if the SetNodeSecurityTags200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SetNodeSecurityTags200ResponseData{}

// SetNodeSecurityTags200ResponseData struct for SetNodeSecurityTags200ResponseData
type SetNodeSecurityTags200ResponseData struct {
	Securitytags []SetNodeSecurityTags200ResponseDataSecuritytagsInner `json:"securitytags"`
}

type _SetNodeSecurityTags200ResponseData SetNodeSecurityTags200ResponseData
...
func NewSetNodeSecurityTags200ResponseData(securitytags []SetNodeSecurityTags200ResponseDataSecuritytagsInner) *SetNodeSecurityTags200ResponseData {
	this := SetNodeSecurityTags200ResponseData{}
...
// GetSecuritytags returns the Securitytags field value
func (o *SetNodeSecurityTags200ResponseData) GetSecuritytags() []SetNodeSecurityTags200ResponseDataSecuritytagsInner {
	if o == nil {
		var ret []SetNodeSecurityTags200ResponseDataSecuritytagsInner
		return ret
	}
...
// GetSecuritytagsOk returns a tuple with the Securitytags field value
...
func (o *SetNodeSecurityTags200ResponseData) GetSecuritytagsOk() ([]SetNodeSecurityTags200ResponseDataSecuritytagsInner, bool) {
	...
	return o.Securitytags, true
}

// SetSecuritytags sets field value
func (o *SetNodeSecurityTags200ResponseData) SetSecuritytags(v []SetNodeSecurityTags200ResponseDataSecuritytagsInner) {
	o.Securitytags = v
}

func (o SetNodeSecurityTags200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o SetNodeSecurityTags200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["securitytags"] = o.Securitytags
	return toSerialize, nil
}

func (o *SetNodeSecurityTags200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varSetNodeSecurityTags200ResponseData := _SetNodeSecurityTags200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSetNodeSecurityTags200ResponseData)

	if err != nil {
		return err
	}

	*o = SetNodeSecurityTags200ResponseData(varSetNodeSecurityTags200ResponseData)

	return err
}

type NullableSetNodeSecurityTags200ResponseData struct {
	value *SetNodeSecurityTags200ResponseData
	isSet bool
}

func (v NullableSetNodeSecurityTags200ResponseData) Get() *SetNodeSecurityTags200ResponseData {
	return v.value
}

func (v *NullableSetNodeSecurityTags200ResponseData) Set(val *SetNodeSecurityTags200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableSetNodeSecurityTags200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableSetNodeSecurityTags200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSetNodeSecurityTags200ResponseData(val *SetNodeSecurityTags200ResponseData) *NullableSetNodeSecurityTags200ResponseData {
	return &NullableSetNodeSecurityTags200ResponseData{value: val, isSet: true}
}

func (v NullableSetNodeSecurityTags200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSetNodeSecurityTags200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
