...
// checks if the RoleCoverage200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoleCoverage200ResponseData{}

// RoleCoverage200ResponseData struct for RoleCoverage200ResponseData
type RoleCoverage200ResponseData struct {
	Coverage RoleCoverage200ResponseDataCoverage `json:"coverage"`
}

type _RoleCoverage200ResponseData RoleCoverage200ResponseData
...
func NewRoleCoverage200ResponseData(coverage RoleCoverage200ResponseDataCoverage) *RoleCoverage200ResponseData {
	this := RoleCoverage200ResponseData{}
...
func (o *RoleCoverage200ResponseData) GetCoverage() RoleCoverage200ResponseDataCoverage {
	if o == nil {
		var ret RoleCoverage200ResponseDataCoverage
		return ret
	}
...
func (o RoleCoverage200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o RoleCoverage200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["coverage"] = o.Coverage
	return toSerialize, nil
}

func (o *RoleCoverage200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varRoleCoverage200ResponseData := _RoleCoverage200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRoleCoverage200ResponseData)

	if err != nil {
		return err
	}

	*o = RoleCoverage200ResponseData(varRoleCoverage200ResponseData)

	return err
}

type NullableRoleCoverage200ResponseData struct {
	value *RoleCoverage200ResponseData
	isSet bool
}

func (v NullableRoleCoverage200ResponseData) Get() *RoleCoverage200ResponseData {
	return v.value
}

func (v *NullableRoleCoverage200ResponseData) Set(val *RoleCoverage200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableRoleCoverage200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableRoleCoverage200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoleCoverage200ResponseData(val *RoleCoverage200ResponseData) *NullableRoleCoverage200ResponseData {
	return &NullableRoleCoverage200ResponseData{value: val, isSet: true}
}

func (v NullableRoleCoverage200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoleCoverage200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
