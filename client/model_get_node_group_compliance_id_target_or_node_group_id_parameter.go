...
// GetNodeGroupComplianceIdTargetOrNodeGroupIdParameter - struct for GetNodeGroupComplianceIdTargetOrNodeGroupIdParameter
type GetNodeGroupComplianceIdTargetOrNodeGroupIdParameter struct {
	RuleTarget *RuleTarget
	String *string
}

// RuleTargetAsGetNodeGroupComplianceIdTargetOrNodeGroupIdParameter is a convenience function that returns RuleTarget wrapped in GetNodeGroupComplianceIdTargetOrNodeGroupIdParameter
func RuleTargetAsGetNodeGroupComplianceIdTargetOrNodeGroupIdParameter(v *RuleTarget) GetNodeGroupComplianceIdTargetOrNodeGroupIdParameter {
	return GetNodeGroupComplianceIdTargetOrNodeGroupIdParameter{
		RuleTarget: v,
	}
}

// stringAsGetNodeGroupComplianceIdTargetOrNodeGroupIdParameter is a convenience function that returns string wrapped in GetNodeGroupComplianceIdTargetOrNodeGroupIdParameter
func StringAsGetNodeGroupComplianceIdTargetOrNodeGroupIdParameter(v *string) GetNodeGroupComplianceIdTargetOrNodeGroupIdParameter {
	return GetNodeGroupComplianceIdTargetOrNodeGroupIdParameter{
		String: v,
	}
}
...
func (dst *GetNodeGroupComplianceIdTargetOrNodeGroupIdParameter) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	// try to unmarshal data into RuleTarget
	err = newStrictDecoder(data).Decode(&dst.RuleTarget)
	if err == nil {
		jsonRuleTarget, _ := json.Marshal(dst.RuleTarget)
		if string(jsonRuleTarget) == "{}" { // empty struct
			dst.RuleTarget = nil
		} else {
			if err = validator.Validate(dst.RuleTarget); err != nil {
				dst.RuleTarget = nil
			} else {
				match++
			}
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(GetNodeGroupComplianceIdTargetOrNodeGroupIdParameter)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(GetNodeGroupComplianceIdTargetOrNodeGroupIdParameter)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src GetNodeGroupComplianceIdTargetOrNodeGroupIdParameter) MarshalJSON() ([]byte, error) {
	if src.RuleTarget != nil {
		return json.Marshal(&src.RuleTarget)
	}
...
func (obj *GetNodeGroupComplianceIdTargetOrNodeGroupIdParameter) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	if obj.RuleTarget != nil {
		return obj.RuleTarget
	}
...
func (obj GetNodeGroupComplianceIdTargetOrNodeGroupIdParameter) GetActualInstanceValue() (interface{}) {
	if obj.RuleTarget != nil {
		return *obj.RuleTarget
	}
...
type NullableGetNodeGroupComplianceIdTargetOrNodeGroupIdParameter struct {
	value *GetNodeGroupComplianceIdTargetOrNodeGroupIdParameter
	isSet bool
}

func (v NullableGetNodeGroupComplianceIdTargetOrNodeGroupIdParameter) Get() *GetNodeGroupComplianceIdTargetOrNodeGroupIdParameter {
	return v.value
}

func (v *NullableGetNodeGroupComplianceIdTargetOrNodeGroupIdParameter) Set(val *GetNodeGroupComplianceIdTargetOrNodeGroupIdParameter) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNodeGroupComplianceIdTargetOrNodeGroupIdParameter) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNodeGroupComplianceIdTargetOrNodeGroupIdParameter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNodeGroupComplianceIdTargetOrNodeGroupIdParameter(val *GetNodeGroupComplianceIdTargetOrNodeGroupIdParameter) *NullableGetNodeGroupComplianceIdTargetOrNodeGroupIdParameter {
	return &NullableGetNodeGroupComplianceIdTargetOrNodeGroupIdParameter{value: val, isSet: true}
}

func (v NullableGetNodeGroupComplianceIdTargetOrNodeGroupIdParameter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNodeGroupComplianceIdTargetOrNodeGroupIdParameter) UnmarshalJSON(src []byte) error {
	v.isSet = true
