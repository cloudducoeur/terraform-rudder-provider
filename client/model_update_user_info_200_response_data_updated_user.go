...
// checks if the UpdateUserInfo200ResponseDataUpdatedUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateUserInfo200ResponseDataUpdatedUser{}

// UpdateUserInfo200ResponseDataUpdatedUser struct for UpdateUserInfo200ResponseDataUpdatedUser
type UpdateUserInfo200ResponseDataUpdatedUser struct {
	Name *string `json:"name,omitempty"`
	Email *string `json:"email,omitempty"`
	OtherInfo map[string]string `json:"otherInfo,omitempty"`
}
...
func NewUpdateUserInfo200ResponseDataUpdatedUser() *UpdateUserInfo200ResponseDataUpdatedUser {
	this := UpdateUserInfo200ResponseDataUpdatedUser{}
	return &this
}
...
// SetOtherInfo gets a reference to the given map[string]string and assigns it to the OtherInfo field.
func (o *UpdateUserInfo200ResponseDataUpdatedUser) SetOtherInfo(v map[string]string) {
	o.OtherInfo = v
}

func (o UpdateUserInfo200ResponseDataUpdatedUser) MarshalJSON() ([]byte, error) {
...
func (o UpdateUserInfo200ResponseDataUpdatedUser) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateUserInfo200ResponseDataUpdatedUser struct {
	value *UpdateUserInfo200ResponseDataUpdatedUser
	isSet bool
}

func (v NullableUpdateUserInfo200ResponseDataUpdatedUser) Get() *UpdateUserInfo200ResponseDataUpdatedUser {
	return v.value
}

func (v *NullableUpdateUserInfo200ResponseDataUpdatedUser) Set(val *UpdateUserInfo200ResponseDataUpdatedUser) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateUserInfo200ResponseDataUpdatedUser) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateUserInfo200ResponseDataUpdatedUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateUserInfo200ResponseDataUpdatedUser(val *UpdateUserInfo200ResponseDataUpdatedUser) *NullableUpdateUserInfo200ResponseDataUpdatedUser {
	return &NullableUpdateUserInfo200ResponseDataUpdatedUser{value: val, isSet: true}
}

func (v NullableUpdateUserInfo200ResponseDataUpdatedUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateUserInfo200ResponseDataUpdatedUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
