...
// checks if the UpdateUserInfo200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateUserInfo200Response{}

// UpdateUserInfo200Response struct for UpdateUserInfo200Response
type UpdateUserInfo200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data UpdateUserInfo200ResponseData `json:"data"`
}

type _UpdateUserInfo200Response UpdateUserInfo200Response
...
func NewUpdateUserInfo200Response(result string, action string, data UpdateUserInfo200ResponseData) *UpdateUserInfo200Response {
	this := UpdateUserInfo200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *UpdateUserInfo200Response) GetData() UpdateUserInfo200ResponseData {
	if o == nil {
		var ret UpdateUserInfo200ResponseData
		return ret
	}
...
func (o UpdateUserInfo200Response) MarshalJSON() ([]byte, error) {
...
func (o UpdateUserInfo200Response) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateUserInfo200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateUserInfo200Response := _UpdateUserInfo200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateUserInfo200Response)

	if err != nil {
		return err
	}

	*o = UpdateUserInfo200Response(varUpdateUserInfo200Response)

	return err
}

type NullableUpdateUserInfo200Response struct {
	value *UpdateUserInfo200Response
	isSet bool
}

func (v NullableUpdateUserInfo200Response) Get() *UpdateUserInfo200Response {
	return v.value
}

func (v *NullableUpdateUserInfo200Response) Set(val *UpdateUserInfo200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateUserInfo200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateUserInfo200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateUserInfo200Response(val *UpdateUserInfo200Response) *NullableUpdateUserInfo200Response {
	return &NullableUpdateUserInfo200Response{value: val, isSet: true}
}

func (v NullableUpdateUserInfo200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateUserInfo200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
