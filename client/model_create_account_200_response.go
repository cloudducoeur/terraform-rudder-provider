...
type _CreateAccount200Response CreateAccount200Response
...
func (o *CreateAccount200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateAccount200Response := _CreateAccount200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateAccount200Response)

	if err != nil {
		return err
	}

	*o = CreateAccount200Response(varCreateAccount200Response)
