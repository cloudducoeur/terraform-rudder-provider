...
// checks if the GetPluginsInfo200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPluginsInfo200ResponseData{}

// GetPluginsInfo200ResponseData Plugins info
type GetPluginsInfo200ResponseData struct {
	Parameters []PluginsInfo `json:"parameters,omitempty"`
}
...
func NewGetPluginsInfo200ResponseData() *GetPluginsInfo200ResponseData {
	this := GetPluginsInfo200ResponseData{}
	return &this
}
...
// SetParameters gets a reference to the given []PluginsInfo and assigns it to the Parameters field.
func (o *GetPluginsInfo200ResponseData) SetParameters(v []PluginsInfo) {
	o.Parameters = v
}

func (o GetPluginsInfo200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetPluginsInfo200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGetPluginsInfo200ResponseData struct {
	value *GetPluginsInfo200ResponseData
	isSet bool
}

func (v NullableGetPluginsInfo200ResponseData) Get() *GetPluginsInfo200ResponseData {
	return v.value
}

func (v *NullableGetPluginsInfo200ResponseData) Set(val *GetPluginsInfo200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPluginsInfo200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPluginsInfo200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPluginsInfo200ResponseData(val *GetPluginsInfo200ResponseData) *NullableGetPluginsInfo200ResponseData {
	return &NullableGetPluginsInfo200ResponseData{value: val, isSet: true}
}

func (v NullableGetPluginsInfo200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPluginsInfo200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
