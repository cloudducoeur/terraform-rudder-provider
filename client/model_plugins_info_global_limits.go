...
// checks if the PluginsInfoGlobalLimits type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PluginsInfoGlobalLimits{}

// PluginsInfoGlobalLimits Most restrictive limits computed from each plugin license limits
type PluginsInfoGlobalLimits struct {
	// list of licensees for these plugins
	Licensees []string `json:"licensees,omitempty"`
	// the latest date of start of validity for plugins
	StartDate *string `json:"startDate,omitempty"`
	// the earliest date of end of validity for plugins
	EndDate *string `json:"endDate,omitempty"`
	// the lowest limit on maximum number of nodes for plugins
...
// GetLicensees returns the Licensees field value if set, zero value otherwise.
func (o *PluginsInfoGlobalLimits) GetLicensees() []string {
	if o == nil || IsNil(o.Licensees) {
		var ret []string
		return ret
	}
	return o.Licensees
...
// GetLicenseesOk returns a tuple with the Licensees field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PluginsInfoGlobalLimits) GetLicenseesOk() ([]string, bool) {
	if o == nil || IsNil(o.Licensees) {
		return nil, false
	}
	return o.Licensees, true
}
...
// SetLicensees gets a reference to the given []string and assigns it to the Licensees field.
...
func (o PluginsInfoGlobalLimits) MarshalJSON() ([]byte, error) {
...
func (o PluginsInfoGlobalLimits) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Licensees) {
		toSerialize["licensees"] = o.Licensees
	}
...
type NullablePluginsInfoGlobalLimits struct {
	value *PluginsInfoGlobalLimits
	isSet bool
}

func (v NullablePluginsInfoGlobalLimits) Get() *PluginsInfoGlobalLimits {
	return v.value
}

func (v *NullablePluginsInfoGlobalLimits) Set(val *PluginsInfoGlobalLimits) {
	v.value = val
	v.isSet = true
}

func (v NullablePluginsInfoGlobalLimits) IsSet() bool {
	return v.isSet
}

func (v *NullablePluginsInfoGlobalLimits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePluginsInfoGlobalLimits(val *PluginsInfoGlobalLimits) *NullablePluginsInfoGlobalLimits {
	return &NullablePluginsInfoGlobalLimits{value: val, isSet: true}
}

func (v NullablePluginsInfoGlobalLimits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePluginsInfoGlobalLimits) UnmarshalJSON(src []byte) error {
	v.isSet = true
