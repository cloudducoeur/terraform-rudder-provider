...
// checks if the ActivateUser200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActivateUser200Response{}

// ActivateUser200Response struct for ActivateUser200Response
type ActivateUser200Response struct {
	...
	Data ActivateUser200ResponseData `json:"data"`
}

type _ActivateUser200Response ActivateUser200Response
...
func (o *ActivateUser200Response) GetData() ActivateUser200ResponseData {
	if o == nil {
		var ret ActivateUser200ResponseData
		return ret
	}
...
func (o ActivateUser200Response) MarshalJSON() ([]byte, error) {
...
func (o ActivateUser200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ActivateUser200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varActivateUser200Response := _ActivateUser200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varActivateUser200Response)

	if err != nil {
		return err
	}

	*o = ActivateUser200Response(varActivateUser200Response)

	return err
}

type NullableActivateUser200Response struct {
	value *ActivateUser200Response
	isSet bool
}

func (v NullableActivateUser200Response) Get() *ActivateUser200Response {
	return v.value
}

func (v *NullableActivateUser200Response) Set(val *ActivateUser200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableActivateUser200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableActivateUser200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActivateUser200Response(val *ActivateUser200Response) *NullableActivateUser200Response {
	return &NullableActivateUser200Response{value: val, isSet: true}
}

func (v NullableActivateUser200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActivateUser200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
