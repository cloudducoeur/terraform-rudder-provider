...
// checks if the NodeDetails200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeDetails200ResponseData{}

// NodeDetails200ResponseData Information about the node
type NodeDetails200ResponseData struct {
	Nodes []NodeFull `json:"nodes"`
}

type _NodeDetails200ResponseData NodeDetails200ResponseData
...
func NewNodeDetails200ResponseData(nodes []NodeFull) *NodeDetails200ResponseData {
	this := NodeDetails200ResponseData{}
	this.Nodes = nodes
	return &this
}
...
func (o NodeDetails200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o NodeDetails200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["nodes"] = o.Nodes
	return toSerialize, nil
}

func (o *NodeDetails200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varNodeDetails200ResponseData := _NodeDetails200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNodeDetails200ResponseData)

	if err != nil {
		return err
	}

	*o = NodeDetails200ResponseData(varNodeDetails200ResponseData)

	return err
}

type NullableNodeDetails200ResponseData struct {
	value *NodeDetails200ResponseData
	isSet bool
}

func (v NullableNodeDetails200ResponseData) Get() *NodeDetails200ResponseData {
	return v.value
}

func (v *NullableNodeDetails200ResponseData) Set(val *NodeDetails200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeDetails200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeDetails200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeDetails200ResponseData(val *NodeDetails200ResponseData) *NullableNodeDetails200ResponseData {
	return &NullableNodeDetails200ResponseData{value: val, isSet: true}
}

func (v NullableNodeDetails200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeDetails200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
