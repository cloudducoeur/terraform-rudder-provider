...
// checks if the GetNodeGroupComplianceId200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNodeGroupComplianceId200ResponseData{}

// GetNodeGroupComplianceId200ResponseData struct for GetNodeGroupComplianceId200ResponseData
type GetNodeGroupComplianceId200ResponseData struct {
	NodeGroups []GetNodeGroupComplianceId200ResponseDataNodeGroupsInner `json:"nodeGroups"`
}

type _GetNodeGroupComplianceId200ResponseData GetNodeGroupComplianceId200ResponseData
...
func NewGetNodeGroupComplianceId200ResponseData(nodeGroups []GetNodeGroupComplianceId200ResponseDataNodeGroupsInner) *GetNodeGroupComplianceId200ResponseData {
	this := GetNodeGroupComplianceId200ResponseData{}
...
func (o *GetNodeGroupComplianceId200ResponseData) GetNodeGroups() []GetNodeGroupComplianceId200ResponseDataNodeGroupsInner {
	if o == nil {
		var ret []GetNodeGroupComplianceId200ResponseDataNodeGroupsInner
		return ret
	}
...
func (o GetNodeGroupComplianceId200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetNodeGroupComplianceId200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["nodeGroups"] = o.NodeGroups
	return toSerialize, nil
}

func (o *GetNodeGroupComplianceId200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varGetNodeGroupComplianceId200ResponseData := _GetNodeGroupComplianceId200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetNodeGroupComplianceId200ResponseData)

	if err != nil {
		return err
	}

	*o = GetNodeGroupComplianceId200ResponseData(varGetNodeGroupComplianceId200ResponseData)

	return err
}

type NullableGetNodeGroupComplianceId200ResponseData struct {
	value *GetNodeGroupComplianceId200ResponseData
	isSet bool
}

func (v NullableGetNodeGroupComplianceId200ResponseData) Get() *GetNodeGroupComplianceId200ResponseData {
	return v.value
}

func (v *NullableGetNodeGroupComplianceId200ResponseData) Set(val *GetNodeGroupComplianceId200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNodeGroupComplianceId200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNodeGroupComplianceId200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNodeGroupComplianceId200ResponseData(val *GetNodeGroupComplianceId200ResponseData) *NullableGetNodeGroupComplianceId200ResponseData {
	return &NullableGetNodeGroupComplianceId200ResponseData{value: val, isSet: true}
}

func (v NullableGetNodeGroupComplianceId200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNodeGroupComplianceId200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
