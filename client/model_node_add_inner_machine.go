...
// checks if the NodeAddInnerMachine type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeAddInnerMachine{}

// NodeAddInnerMachine The kind of machine for the node (use vm for a generic VM)
type NodeAddInnerMachine struct {
...
type _NodeAddInnerMachine NodeAddInnerMachine
...
func (o NodeAddInnerMachine) MarshalJSON() ([]byte, error) {
...
func (o NodeAddInnerMachine) ToMap() (map[string]interface{}, error) {
...
func (o *NodeAddInnerMachine) UnmarshalJSON(data []byte) (err error) {
	...
	varNodeAddInnerMachine := _NodeAddInnerMachine{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNodeAddInnerMachine)

	if err != nil {
		return err
	}

	*o = NodeAddInnerMachine(varNodeAddInnerMachine)

	return err
}

type NullableNodeAddInnerMachine struct {
	value *NodeAddInnerMachine
	isSet bool
}

func (v NullableNodeAddInnerMachine) Get() *NodeAddInnerMachine {
	return v.value
}

func (v *NullableNodeAddInnerMachine) Set(val *NodeAddInnerMachine) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeAddInnerMachine) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeAddInnerMachine) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeAddInnerMachine(val *NodeAddInnerMachine) *NullableNodeAddInnerMachine {
	return &NullableNodeAddInnerMachine{value: val, isSet: true}
}

func (v NullableNodeAddInnerMachine) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeAddInnerMachine) UnmarshalJSON(src []byte) error {
	v.isSet = true
