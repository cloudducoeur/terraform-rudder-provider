...
// checks if the GetNodeGroupComplianceId200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNodeGroupComplianceId200Response{}

// GetNodeGroupComplianceId200Response struct for GetNodeGroupComplianceId200Response
type GetNodeGroupComplianceId200Response struct {
...
type _GetNodeGroupComplianceId200Response GetNodeGroupComplianceId200Response
...
func NewGetNodeGroupComplianceId200Response(result string, action string, data GetNodeGroupComplianceId200ResponseData) *GetNodeGroupComplianceId200Response {
	this := GetNodeGroupComplianceId200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o GetNodeGroupComplianceId200Response) MarshalJSON() ([]byte, error) {
...
func (o GetNodeGroupComplianceId200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetNodeGroupComplianceId200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetNodeGroupComplianceId200Response := _GetNodeGroupComplianceId200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetNodeGroupComplianceId200Response)

	if err != nil {
		return err
	}

	*o = GetNodeGroupComplianceId200Response(varGetNodeGroupComplianceId200Response)

	return err
}

type NullableGetNodeGroupComplianceId200Response struct {
	value *GetNodeGroupComplianceId200Response
	isSet bool
}

func (v NullableGetNodeGroupComplianceId200Response) Get() *GetNodeGroupComplianceId200Response {
	return v.value
}

func (v *NullableGetNodeGroupComplianceId200Response) Set(val *GetNodeGroupComplianceId200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNodeGroupComplianceId200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNodeGroupComplianceId200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNodeGroupComplianceId200Response(val *GetNodeGroupComplianceId200Response) *NullableGetNodeGroupComplianceId200Response {
	return &NullableGetNodeGroupComplianceId200Response{value: val, isSet: true}
}

func (v NullableGetNodeGroupComplianceId200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNodeGroupComplianceId200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
