...
// checks if the AddTenants200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddTenants200Response{}

// AddTenants200Response struct for AddTenants200Response
type AddTenants200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data GetTenants200ResponseData `json:"data"`
}

type _AddTenants200Response AddTenants200Response
...
func (o *AddTenants200Response) GetData() GetTenants200ResponseData {
	if o == nil {
		var ret GetTenants200ResponseData
		return ret
	}
...
func (o AddTenants200Response) MarshalJSON() ([]byte, error) {
...
func (o AddTenants200Response) ToMap() (map[string]interface{}, error) {
...
func (o *AddTenants200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varAddTenants200Response := _AddTenants200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAddTenants200Response)

	if err != nil {
		return err
	}

	*o = AddTenants200Response(varAddTenants200Response)

	return err
}

type NullableAddTenants200Response struct {
	value *AddTenants200Response
	isSet bool
}

func (v NullableAddTenants200Response) Get() *AddTenants200Response {
	return v.value
}

func (v *NullableAddTenants200Response) Set(val *AddTenants200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableAddTenants200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableAddTenants200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddTenants200Response(val *AddTenants200Response) *NullableAddTenants200Response {
	return &NullableAddTenants200Response{value: val, isSet: true}
}

func (v NullableAddTenants200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddTenants200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
