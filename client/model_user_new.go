...
type UserNew struct {
	...
	IsPreHashed bool `json:"isPreHashed"`
...
// GetIsPreHashed returns the IsPreHashed field value
func (o *UserNew) GetIsPreHashed() bool {
	...
	return o.IsPreHashed
}

// GetIsPreHashedOk returns a tuple with the IsPreHashed field value
// and a boolean to check if the value has been set.
func (o *UserNew) GetIsPreHashedOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.IsPreHashed, true
}

// SetIsPreHashed sets field value
...
func (o UserNew) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["isPreHashed"] = o.IsPreHashed
	if !IsNil(o.Name) {
