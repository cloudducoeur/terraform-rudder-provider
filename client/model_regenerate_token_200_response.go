...
// checks if the RegenerateToken200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegenerateToken200Response{}

// RegenerateToken200Response struct for RegenerateToken200Response
type RegenerateToken200Response struct {
	...
	Data GetAllAccounts200ResponseData `json:"data"`
}

type _RegenerateToken200Response RegenerateToken200Response
...
func NewRegenerateToken200Response(result string, id string, action string, data GetAllAccounts200ResponseData) *RegenerateToken200Response {
	this := RegenerateToken200Response{}
	this.Result = result
	this.Id = id
	this.Action = action
	this.Data = data
...
func (o *RegenerateToken200Response) GetData() GetAllAccounts200ResponseData {
	if o == nil {
		var ret GetAllAccounts200ResponseData
		return ret
	}
...
func (o RegenerateToken200Response) MarshalJSON() ([]byte, error) {
...
func (o RegenerateToken200Response) ToMap() (map[string]interface{}, error) {
...
func (o *RegenerateToken200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varRegenerateToken200Response := _RegenerateToken200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRegenerateToken200Response)

	if err != nil {
		return err
	}

	*o = RegenerateToken200Response(varRegenerateToken200Response)

	return err
}

type NullableRegenerateToken200Response struct {
	value *RegenerateToken200Response
	isSet bool
}

func (v NullableRegenerateToken200Response) Get() *RegenerateToken200Response {
	return v.value
}

func (v *NullableRegenerateToken200Response) Set(val *RegenerateToken200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableRegenerateToken200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableRegenerateToken200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegenerateToken200Response(val *RegenerateToken200Response) *NullableRegenerateToken200Response {
	return &NullableRegenerateToken200Response{value: val, isSet: true}
}

func (v NullableRegenerateToken200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegenerateToken200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
