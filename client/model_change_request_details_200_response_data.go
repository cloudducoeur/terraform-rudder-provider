...
// checks if the ChangeRequestDetails200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangeRequestDetails200ResponseData{}

// ChangeRequestDetails200ResponseData struct for ChangeRequestDetails200ResponseData
type ChangeRequestDetails200ResponseData struct {
	ChangeRequests []ChangeRequest `json:"changeRequests"`
}

type _ChangeRequestDetails200ResponseData ChangeRequestDetails200ResponseData
...
func NewChangeRequestDetails200ResponseData(changeRequests []ChangeRequest) *ChangeRequestDetails200ResponseData {
	this := ChangeRequestDetails200ResponseData{}
...
func (o ChangeRequestDetails200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o ChangeRequestDetails200ResponseData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["changeRequests"] = o.ChangeRequests
	return toSerialize, nil
}

func (o *ChangeRequestDetails200ResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varChangeRequestDetails200ResponseData := _ChangeRequestDetails200ResponseData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varChangeRequestDetails200ResponseData)

	if err != nil {
		return err
	}

	*o = ChangeRequestDetails200ResponseData(varChangeRequestDetails200ResponseData)

	return err
}

type NullableChangeRequestDetails200ResponseData struct {
	value *ChangeRequestDetails200ResponseData
	isSet bool
}

func (v NullableChangeRequestDetails200ResponseData) Get() *ChangeRequestDetails200ResponseData {
	return v.value
}

func (v *NullableChangeRequestDetails200ResponseData) Set(val *ChangeRequestDetails200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableChangeRequestDetails200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableChangeRequestDetails200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangeRequestDetails200ResponseData(val *ChangeRequestDetails200ResponseData) *NullableChangeRequestDetails200ResponseData {
	return &NullableChangeRequestDetails200ResponseData{value: val, isSet: true}
}

func (v NullableChangeRequestDetails200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangeRequestDetails200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
