...
// checks if the DeleteNodeSecurityTag200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteNodeSecurityTag200Response{}

// DeleteNodeSecurityTag200Response struct for DeleteNodeSecurityTag200Response
type DeleteNodeSecurityTag200Response struct {
	// Result of the request
	Result string `json:"result"`
	// The id of the action
	Action string `json:"action"`
	Data DeleteNodeSecurityTag200ResponseData `json:"data"`
}

type _DeleteNodeSecurityTag200Response DeleteNodeSecurityTag200Response
...
func NewDeleteNodeSecurityTag200Response(result string, action string, data DeleteNodeSecurityTag200ResponseData) *DeleteNodeSecurityTag200Response {
	this := DeleteNodeSecurityTag200Response{}
	this.Result = result
	this.Action = action
	this.Data = data
	return &this
...
func (o *DeleteNodeSecurityTag200Response) GetData() DeleteNodeSecurityTag200ResponseData {
	if o == nil {
		var ret DeleteNodeSecurityTag200ResponseData
		return ret
	}
...
func (o DeleteNodeSecurityTag200Response) MarshalJSON() ([]byte, error) {
...
func (o DeleteNodeSecurityTag200Response) ToMap() (map[string]interface{}, error) {
...
func (o *DeleteNodeSecurityTag200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteNodeSecurityTag200Response := _DeleteNodeSecurityTag200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteNodeSecurityTag200Response)

	if err != nil {
		return err
	}

	*o = DeleteNodeSecurityTag200Response(varDeleteNodeSecurityTag200Response)

	return err
}

type NullableDeleteNodeSecurityTag200Response struct {
	value *DeleteNodeSecurityTag200Response
	isSet bool
}

func (v NullableDeleteNodeSecurityTag200Response) Get() *DeleteNodeSecurityTag200Response {
	return v.value
}

func (v *NullableDeleteNodeSecurityTag200Response) Set(val *DeleteNodeSecurityTag200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteNodeSecurityTag200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteNodeSecurityTag200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteNodeSecurityTag200Response(val *DeleteNodeSecurityTag200Response) *NullableDeleteNodeSecurityTag200Response {
	return &NullableDeleteNodeSecurityTag200Response{value: val, isSet: true}
}

func (v NullableDeleteNodeSecurityTag200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteNodeSecurityTag200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
