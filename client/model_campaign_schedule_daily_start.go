...
// checks if the CampaignScheduleDailyStart type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CampaignScheduleDailyStart{}

// CampaignScheduleDailyStart Date when the campaign should start
type CampaignScheduleDailyStart struct {
...
func NewCampaignScheduleDailyStart() *CampaignScheduleDailyStart {
	this := CampaignScheduleDailyStart{}
	return &this
}
...
func (o CampaignScheduleDailyStart) MarshalJSON() ([]byte, error) {
...
func (o CampaignScheduleDailyStart) ToMap() (map[string]interface{}, error) {
...
type NullableCampaignScheduleDailyStart struct {
	value *CampaignScheduleDailyStart
	isSet bool
}

func (v NullableCampaignScheduleDailyStart) Get() *CampaignScheduleDailyStart {
	return v.value
}

func (v *NullableCampaignScheduleDailyStart) Set(val *CampaignScheduleDailyStart) {
	v.value = val
	v.isSet = true
}

func (v NullableCampaignScheduleDailyStart) IsSet() bool {
	return v.isSet
}

func (v *NullableCampaignScheduleDailyStart) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCampaignScheduleDailyStart(val *CampaignScheduleDailyStart) *NullableCampaignScheduleDailyStart {
	return &NullableCampaignScheduleDailyStart{value: val, isSet: true}
}

func (v NullableCampaignScheduleDailyStart) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCampaignScheduleDailyStart) UnmarshalJSON(src []byte) error {
	v.isSet = true
